...
HX_DEFINE_STACK_FRAME(_hx_pos_32211c0ca20fb474_130_new,"flixel.system.VirtualInputData","new",0x4566b028,"flixel.system.VirtualInputData.new","lime/_internal/macros/AssetsMacro.hx",130,0xc651f030)
...
void VirtualInputData_obj::__construct( ::Dynamic __o_length){
 ::Dynamic length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_32211c0ca20fb474_130_new)
