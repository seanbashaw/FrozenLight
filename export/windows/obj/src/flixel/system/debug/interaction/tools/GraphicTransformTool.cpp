...
HX_DEFINE_STACK_FRAME(_hx_pos_08092bacb9a7bf01_51_new,"flixel.system.debug.interaction.tools.GraphicTransformTool","new",0xf4f33c85,"flixel.system.debug.interaction.tools.GraphicTransformTool.new","openfl/_internal/macros/AssetsMacro.hx",51,0xf7db08ab)
...
void GraphicTransformTool_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_08092bacb9a7bf01_51_new)
HXLINE(  83)		super::__construct((int)0,(int)0,transparent,fillRGBA);
HXLINE(  85)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicTransformTool_obj::resourceName));
HXLINE(  86)		{
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicTransformTool",2c,3b,f8,c6);
            	}
}
