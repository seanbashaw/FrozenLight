...
HX_DEFINE_STACK_FRAME(_hx_pos_fa6bbd6c5d089215_70_new,"__ASSET__flixel_sounds_beep_ogg","new",0x0aaf31f8,"__ASSET__flixel_sounds_beep_ogg.new","lime/_internal/macros/AssetsMacro.hx",70,0xc651f030)
...
void __ASSET__flixel_sounds_beep_ogg_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_fa6bbd6c5d089215_70_new)
HXLINE(  72)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_sounds_beep_ogg_obj::resourceName);
