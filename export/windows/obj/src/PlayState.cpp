...
void PlayState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_af23706db05c7feb_13_update)
HXLINE(  14)		this->super::update(elapsed);
HXLINE(  15)		 ::flixel::text::FlxText text =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)0,HX_("Frozen Light",56,5a,6f,87),(int)64,null());
HXLINE(  16)		text->screenCenter(null());
HXLINE(  17)		this->add(text);
            	}
