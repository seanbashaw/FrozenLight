...
HX_DEFINE_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_64_new,"openfl.text.Font","new",0xe13d5ce4,"openfl.text.Font.new","openfl/text/Font.hx",64,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_188___fromLimeFont,"openfl.text.Font","__fromLimeFont",0x57c4282a,"openfl.text.Font.__fromLimeFont","openfl/text/Font.hx",188,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_193___initialize,"openfl.text.Font","__initialize",0x3f396f6c,"openfl.text.Font.__initialize","openfl/text/Font.hx",193,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_226_get_fontName,"openfl.text.Font","get_fontName",0x9a8206bf,"openfl.text.Font.get_fontName","openfl/text/Font.hx",226,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_233_set_fontName,"openfl.text.Font","set_fontName",0xaf7b2a33,"openfl.text.Font.set_fontName","openfl/text/Font.hx",233,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_84_enumerateFonts,"openfl.text.Font","enumerateFonts",0x792ac3fc,"openfl.text.Font.enumerateFonts","openfl/text/Font.hx",84,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_89_fromBytes,"openfl.text.Font","fromBytes",0x95ccba25,"openfl.text.Font.fromBytes","openfl/text/Font.hx",89,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_103_fromFile,"openfl.text.Font","fromFile",0x919e3202,"openfl.text.Font.fromFile","openfl/text/Font.hx",103,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_122_loadFromBytes,"openfl.text.Font","loadFromBytes",0x88069d1f,"openfl.text.Font.loadFromBytes","openfl/text/Font.hx",122,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_136_loadFromFile,"openfl.text.Font","loadFromFile",0x74db4c48,"openfl.text.Font.loadFromFile","openfl/text/Font.hx",136,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_150_loadFromName,"openfl.text.Font","loadFromName",0x7a1ef017,"openfl.text.Font.loadFromName","openfl/text/Font.hx",150,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_166_registerFont,"openfl.text.Font","registerFont",0xd99a60ce,"openfl.text.Font.registerFont","openfl/text/Font.hx",166,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_46_boot,"openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",46,0x076bbaac)
HX_LOCAL_STACK_FRAME(_hx_pos_bf5c0d6977753a1b_47_boot,"openfl.text.Font","boot",0x2c8ceb2e,"openfl.text.Font.boot","openfl/text/Font.hx",47,0x076bbaac)
namespace openfl{
namespace text{

void Font_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_64_new)
HXDLIN(  64)		super::__construct(name);
            	}
...
void Font_obj::_hx___fromLimeFont( ::lime::text::Font font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_188___fromLimeFont)
HXDLIN( 188)		this->_hx___copyFrom(font);
            	}
...
bool Font_obj::_hx___initialize(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_193___initialize)
HXLINE( 196)		if (!(this->_hx___initialized)) {
HXLINE( 198)			if (hx::IsNotNull( this->src )) {
HXLINE( 200)				this->_hx___initialized = true;
            			}
            			else {
HXLINE( 202)				bool _hx_tmp;
HXDLIN( 202)				bool _hx_tmp1;
HXDLIN( 202)				if (hx::IsNull( this->src )) {
HXLINE( 202)					_hx_tmp1 = hx::IsNotNull( this->_hx___fontID );
            				}
            				else {
HXLINE( 202)					_hx_tmp1 = false;
            				}
HXDLIN( 202)				if (_hx_tmp1) {
HXLINE( 202)					_hx_tmp = ::openfl::utils::Assets_obj::isLocal(this->_hx___fontID,null(),null());
            				}
            				else {
HXLINE( 202)					_hx_tmp = false;
            				}
HXDLIN( 202)				if (_hx_tmp) {
HXLINE( 204)					this->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(::openfl::utils::Assets_obj::getBytes(this->_hx___fontID)));
HXLINE( 205)					this->_hx___initialized = true;
            				}
            			}
            		}
HXLINE( 212)		return this->_hx___initialized;
            	}
...
::String Font_obj::get_fontName(){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_226_get_fontName)
HXDLIN( 226)		return this->name;
            	}
...
::String Font_obj::set_fontName(::String value){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_233_set_fontName)
HXDLIN( 233)		return (this->name = value);
            	}
...
bool enumerateDeviceFonts = __o_enumerateDeviceFonts.Default(false);
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_84_enumerateFonts)
HXDLIN(  84)		return ::openfl::text::Font_obj::_hx___registeredFonts;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,enumerateFonts,return )
 ...
 ::openfl::text::Font Font_obj::fromBytes( ::openfl::utils::ByteArrayData bytes){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_89_fromBytes)
HXLINE(  91)		 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE(  92)		font->_hx___fromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes));
HXLINE(  95)		if (hx::IsNotNull( font->src )) {
HXLINE(  95)			return font;
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,fromBytes,return )
 ...
 ::openfl::text::Font Font_obj::fromFile(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_103_fromFile)
HXLINE( 105)		 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 106)		font->_hx___fromFile(path);
HXLINE( 109)		if (hx::IsNotNull( font->src )) {
HXLINE( 109)			return font;
            		}
            		else {
 ...
 ::lime::app::Future Font_obj::loadFromBytes( ::openfl::utils::ByteArrayData bytes){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_122_loadFromBytes)
HXLINE( 124)			 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 125)			font->_hx___fromLimeFont(limeFont);
HXLINE( 127)			return ::lime::app::Future_obj::withValue(font);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_122_loadFromBytes)
HXDLIN( 122)		return ::lime::text::Font_obj::loadFromBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes))->then( ::Dynamic(new _hx_Closure_0()));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,loadFromBytes,return )
 ...
 ::lime::app::Future Font_obj::loadFromFile(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_136_loadFromFile)
HXLINE( 138)			 ::openfl::text::Font font =  ::openfl::text::Font_obj::__alloc( HX_CTX ,null());
HXLINE( 139)			font->_hx___fromLimeFont(limeFont);
HXLINE( 141)			return ::lime::app::Future_obj::withValue(font);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_136_loadFromFile)
HXDLIN( 136)		return ::lime::text::Font_obj::loadFromFile(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Font_obj,loadFromFile,return )
 ...
 ::lime::app::Future Font_obj::loadFromName(::String path){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::lime::text::Font limeFont){
            			HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_150_loadFromName)
...
HXLINE( 155)			return ::lime::app::Future_obj::withValue(font);
            	...
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_150_loadFromName)
HXDLIN( 150)		return ::lime::text::Font_obj::loadFromName(path)->then( ::Dynamic(new _hx_Closure_0()));
            	}
...
void Font_obj::registerFont(hx::Class font){
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_166_registerFont)
HXLINE( 168)		 ::openfl::text::Font instance = hx::TCast<  ::openfl::text::Font >::cast(::Type_obj::createInstance(font,::cpp::VirtualArray_obj::__new(0)));
HXLINE( 170)		if (hx::IsNotNull( instance )) {
HXLINE( 178)			::openfl::text::Font_obj::_hx___registeredFonts->push(instance);
HXLINE( 179)			::openfl::text::Font_obj::_hx___fontByName->set(instance->name,instance);
            		}
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_46_boot)
HXDLIN(  46)		_hx___fontByName =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_47_boot)
HXDLIN(  47)		_hx___registeredFonts = ::Array_obj< ::Dynamic>::__new();
            	}
}
