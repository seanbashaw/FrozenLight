...
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_58_hide,"openfl.ui.Mouse","hide",0x974c7e47,"openfl.ui.Mouse.hide","openfl/ui/Mouse.hx",58,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_81_show,"openfl.ui.Mouse","show",0x9e911e82,"openfl.ui.Mouse.show","openfl/ui/Mouse.hx",81,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_106_get_cursor,"openfl.ui.Mouse","get_cursor",0xfdb1b9e4,"openfl.ui.Mouse.get_cursor","openfl/ui/Mouse.hx",106,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_111_set_cursor,"openfl.ui.Mouse","set_cursor",0x012f5858,"openfl.ui.Mouse.set_cursor","openfl/ui/Mouse.hx",111,0xeac39ff5)
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_32_boot,"openfl.ui.Mouse","boot",0x9359cdb7,"openfl.ui.Mouse.boot","openfl/ui/Mouse.hx",32,0xeac39ff5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9dfd1f611dbbe53a_35_boot,"openfl.ui.Mouse","boot",0x9359cdb7,"openfl.ui.Mouse.boot","openfl/ui/Mouse.hx",35,0xeac39ff5)
namespace openfl{
namespace ui{
...
void Mouse_obj::hide(){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_58_hide)
HXDLIN(  58)		int _g = (int)0;
HXDLIN(  58)		::Array< ::Dynamic> _g1 = ::lime::app::Application_obj::current->_hx___windows;
HXDLIN(  58)		while((_g < _g1->length)){
HXDLIN(  58)			 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN(  58)			_g = (_g + (int)1);
HXLINE(  60)			window->set_cursor(null());
            		}
            	}
...
void Mouse_obj::show(){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_81_show)
...
::String Mouse_obj::get_cursor(){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_106_get_cursor)
HXDLIN( 106)		return ::openfl::ui::Mouse_obj::_hx___cursor;
            	}
...
::String Mouse_obj::set_cursor(::String value){
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_111_set_cursor)
HXLINE( 114)		if (hx::IsNull( value )) {
HXLINE( 114)			value = HX_("auto",6f,df,76,40);
            		}
HXLINE( 115)		 ::lime::ui::MouseCursor setCursor = null();
HXLINE( 117)		::String _hx_switch_0 = value;
            		if (  (_hx_switch_0==HX_("arrow",c9,79,8f,25)) ){
HXLINE( 119)			setCursor = ::lime::ui::MouseCursor_obj::ARROW_dyn();
HXDLIN( 119)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("button",f2,61,e0,d9)) ){
HXLINE( 120)			setCursor = ::lime::ui::MouseCursor_obj::POINTER_dyn();
HXDLIN( 120)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("crosshair",a2,46,c8,8a)) ){
HXLINE( 123)			setCursor = ::lime::ui::MouseCursor_obj::CROSSHAIR_dyn();
HXDLIN( 123)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("custom",b1,87,92,3f)) ){
HXLINE( 124)			setCursor = ::lime::ui::MouseCursor_obj::CUSTOM_dyn();
HXDLIN( 124)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("hand",6f,2b,08,45)) ){
HXLINE( 121)			setCursor = ::lime::ui::MouseCursor_obj::MOVE_dyn();
HXDLIN( 121)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("ibeam",58,ca,26,b6)) ){
HXLINE( 122)			setCursor = ::lime::ui::MouseCursor_obj::TEXT_dyn();
HXDLIN( 122)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_nesw",06,ae,e9,a7)) ){
HXLINE( 125)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_NESW_dyn();
HXDLIN( 125)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_ns",f0,cc,f2,ab)) ){
HXLINE( 126)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_NS_dyn();
HXDLIN( 126)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_nwse",86,56,f7,a7)) ){
HXLINE( 127)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_NWSE_dyn();
HXDLIN( 127)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("resize_we",b9,d4,f2,ab)) ){
HXLINE( 128)			setCursor = ::lime::ui::MouseCursor_obj::RESIZE_WE_dyn();
HXDLIN( 128)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("wait",75,5a,f2,4e)) ){
HXLINE( 129)			setCursor = ::lime::ui::MouseCursor_obj::WAIT_dyn();
HXDLIN( 129)			goto _hx_goto_4;
            		}
            		if (  (_hx_switch_0==HX_("waitarrow",34,17,98,4f)) ){
HXLINE( 130)			setCursor = ::lime::ui::MouseCursor_obj::WAIT_ARROW_dyn();
HXDLIN( 130)			goto _hx_goto_4;
            		}
            		/* default */{
            		}
            		_hx_goto_4:;
HXLINE( 135)		if (hx::IsNotNull( setCursor )) {
HXLINE( 137)			int _g = (int)0;
HXDLIN( 137)			::Array< ::Dynamic> _g1 = ::lime::app::Application_obj::current->_hx___windows;
HXDLIN( 137)			while((_g < _g1->length)){
HXLINE( 137)				 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 137)				_g = (_g + (int)1);
HXLINE( 139)				window->set_cursor(setCursor);
            			}
            		}
HXLINE( 164)		return (::openfl::ui::Mouse_obj::_hx___cursor = value);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_32_boot)
HXDLIN(  32)		supportsCursor = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_33_boot)
HXDLIN(  33)		supportsNativeCursor = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9dfd1f611dbbe53a_35_boot)
HXDLIN(  35)		_hx___cursor = HX_("auto",6f,df,76,40);
            	}
}
