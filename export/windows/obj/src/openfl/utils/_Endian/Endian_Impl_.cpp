...
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_30_fromLimeEndian,"openfl.utils._Endian.Endian_Impl_","fromLimeEndian",0x810f0bde,"openfl.utils._Endian.Endian_Impl_.fromLimeEndian","openfl/utils/Endian.hx",30,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_43_fromString,"openfl.utils._Endian.Endian_Impl_","fromString",0x910e541f,"openfl.utils._Endian.Endian_Impl_.fromString","openfl/utils/Endian.hx",43,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_56_toLimeEndian,"openfl.utils._Endian.Endian_Impl_","toLimeEndian",0x6c00922f,"openfl.utils._Endian.Endian_Impl_.toLimeEndian","openfl/utils/Endian.hx",56,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_69_toString,"openfl.utils._Endian.Endian_Impl_","toString",0x9a281df0,"openfl.utils._Endian.Endian_Impl_.toString","openfl/utils/Endian.hx",69,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_24_boot,"openfl.utils._Endian.Endian_Impl_","boot",0x6ccbdf76,"openfl.utils._Endian.Endian_Impl_.boot","openfl/utils/Endian.hx",24,0xb1ee6086)
HX_LOCAL_STACK_FRAME(_hx_pos_f2873c031a8a146e_25_boot,"openfl.utils._Endian.Endian_Impl_","boot",0x6ccbdf76,"openfl.utils._Endian.Endian_Impl_.boot","openfl/utils/Endian.hx",25,0xb1ee6086)
namespace openfl{
namespace utils{
namespace _Endian{
...
bool Endian_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Endian_Impl__obj::fromLimeEndian( ::lime::_hx_system::Endian value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_30_fromLimeEndian)
HXDLIN(  30)		switch((int)(_hx_getEnumValueIndex(value))){
            			case (int)0: {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Endian_Impl__obj,fromLimeEndian,return )
 ...
 ::Dynamic Endian_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_43_fromString)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Endian_Impl__obj,fromString,return )
 ...
 ::lime::_hx_system::Endian Endian_Impl__obj::toLimeEndian(int value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_56_toLimeEndian)
HXDLIN(  56)		switch((int)(value)){
            			case (int)0: {
HXLINE(  58)				return ::lime::_hx_system::Endian_obj::_hx_BIG_ENDIAN_dyn();
            			}
            			break;
            			case (int)1: {
HXLINE(  59)				return ::lime::_hx_system::Endian_obj::_hx_LITTLE_ENDIAN_dyn();
            			}
            			break;
            			default:{
...
::String Endian_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_69_toString)
HXDLIN(  69)		switch((int)(value)){
            			case (int)0: {
HXLINE(  71)				return HX_("bigEndian",7b,d5,5a,20);
            			}
            			break;
            			case (int)1: {
HXLINE(  72)				return HX_("littleEndian",31,2e,7b,07);
            			}
            			break;
            			default:{
...
{
{
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_24_boot)
HXDLIN(  24)		_hx_BIG_ENDIAN = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_25_boot)
HXDLIN(  25)		_hx_LITTLE_ENDIAN = (int)1;
            	}
}
