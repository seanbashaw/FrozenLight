...
HX_DEFINE_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1152_new,"openfl.display.InteractiveObject","new",0x042d7309,"openfl.display.InteractiveObject.new","openfl/display/InteractiveObject.hx",1152,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1181_requestSoftKeyboard,"openfl.display.InteractiveObject","requestSoftKeyboard",0x985d3a49,"openfl.display.InteractiveObject.requestSoftKeyboard","openfl/display/InteractiveObject.hx",1181,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1192___allowMouseFocus,"openfl.display.InteractiveObject","__allowMouseFocus",0x4a3f2aa5,"openfl.display.InteractiveObject.__allowMouseFocus","openfl/display/InteractiveObject.hx",1192,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1197___getInteractive,"openfl.display.InteractiveObject","__getInteractive",0xf3ec43c3,"openfl.display.InteractiveObject.__getInteractive","openfl/display/InteractiveObject.hx",1197,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1216___hitTest,"openfl.display.InteractiveObject","__hitTest",0x5938388e,"openfl.display.InteractiveObject.__hitTest","openfl/display/InteractiveObject.hx",1216,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1233_get_tabEnabled,"openfl.display.InteractiveObject","get_tabEnabled",0x09837aec,"openfl.display.InteractiveObject.get_tabEnabled","openfl/display/InteractiveObject.hx",1233,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1240_set_tabEnabled,"openfl.display.InteractiveObject","set_tabEnabled",0x29a36360,"openfl.display.InteractiveObject.set_tabEnabled","openfl/display/InteractiveObject.hx",1240,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1247_get_tabIndex,"openfl.display.InteractiveObject","get_tabIndex",0x2bde10bd,"openfl.display.InteractiveObject.get_tabIndex","openfl/display/InteractiveObject.hx",1247,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1254_set_tabIndex,"openfl.display.InteractiveObject","set_tabIndex",0x40d73431,"openfl.display.InteractiveObject.set_tabIndex","openfl/display/InteractiveObject.hx",1254,0x983a3689)
namespace openfl{
namespace display{

void InteractiveObject_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1152_new)
HXLINE(1154)		super::__construct();
HXLINE(1156)		this->doubleClickEnabled = false;
HXLINE(1157)		this->mouseEnabled = true;
HXLINE(1158)		this->needsSoftKeyboard = false;
HXLINE(1159)		this->_hx___tabEnabled = null();
HXLINE(1160)		this->_hx___tabIndex = (int)-1;
            	}
...
bool InteractiveObject_obj::requestSoftKeyboard(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1181_requestSoftKeyboard)
HXLINE(1183)		::openfl::_internal::Lib_obj::notImplemented(hx::SourceInfo(HX_("InteractiveObject.hx",3d,87,79,89),1183,HX_("openfl.display.InteractiveObject",97,3a,cb,f4),HX_("requestSoftKeyboard",a0,f5,a9,d4)));
...
bool InteractiveObject_obj::_hx___allowMouseFocus(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1192___allowMouseFocus)
HXDLIN(1192)		return this->get_tabEnabled();
            	}
...
bool InteractiveObject_obj::_hx___getInteractive(::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1197___getInteractive)
HXLINE(1199)		if (hx::IsNotNull( stack )) {
HXLINE(1201)			stack->push(hx::ObjectPtr<OBJ_>(this));
HXLINE(1203)			if (hx::IsNotNull( this->parent )) {
HXLINE(1205)				this->parent->_hx___getInteractive(stack);
            			}
            		}
...
bool InteractiveObject_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1216___hitTest)
HXLINE(1218)		bool _hx_tmp;
HXDLIN(1218)		bool _hx_tmp1;
HXDLIN(1218)		if (!(!(hitObject->get_visible()))) {
HXLINE(1218)			_hx_tmp1 = this->_hx___isMask;
            		}
            		else {
HXLINE(1218)			_hx_tmp1 = true;
            		}
HXDLIN(1218)		if (!(_hx_tmp1)) {
HXLINE(1218)			if (interactiveOnly) {
HXLINE(1218)				_hx_tmp = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE(1219)		return this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}


bool InteractiveObject_obj::get_tabEnabled(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1233_get_tabEnabled)
HXDLIN(1233)		if (hx::IsEq( this->_hx___tabEnabled,true )) {
HXDLIN(1233)			return true;
            		}
            		else {
HXDLIN(1233)			return false;
            		}
HXDLIN(1233)		return false;
            	}
...
bool InteractiveObject_obj::set_tabEnabled(bool value){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1240_set_tabEnabled)
HXDLIN(1240)		return (this->_hx___tabEnabled = value);
            	}
...
int InteractiveObject_obj::get_tabIndex(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1247_get_tabIndex)
HXDLIN(1247)		return this->_hx___tabIndex;
            	}
...
int InteractiveObject_obj::set_tabIndex(int value){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1254_set_tabIndex)
HXDLIN(1254)		return (this->_hx___tabIndex = value);
            	}
