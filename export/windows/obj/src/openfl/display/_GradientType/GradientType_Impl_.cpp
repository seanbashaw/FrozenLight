...
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_26_fromString,"openfl.display._GradientType.GradientType_Impl_","fromString",0x32cb6550,"openfl.display._GradientType.GradientType_Impl_.fromString","openfl/display/GradientType.hx",26,0xadf6e848)
HX_LOCAL_STACK_FRAME(_hx_pos_b8cb0a95bea7ff48_39_toString,"openfl.display._GradientType.GradientType_Impl_","toString",0xdcddd0e1,"openfl.display._GradientType.GradientType_Impl_.toString","openfl/display/GradientType.hx",39,0xadf6e848)
...
bool GradientType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic GradientType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_26_fromString)
...
::String GradientType_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_b8cb0a95bea7ff48_39_toString)
HXDLIN(  39)		switch((int)(value)){
            			case (int)0: {
HXLINE(  41)				return HX_("linear",e5,51,a0,ec);
            			}
            			break;
            			case (int)1: {
HXLINE(  42)				return HX_("radial",df,be,f6,b0);
            			}
            			break;
            			default:{
