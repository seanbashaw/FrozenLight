...
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_45_fromString,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","fromString",0x8e1d4c22,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.fromString","openfl/display/InterpolationMethod.hx",45,0x1fa1c725)
HX_LOCAL_STACK_FRAME(_hx_pos_35fa8dd9a2d72011_58_toString,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_","toString",0x7209ff33,"openfl.display._InterpolationMethod.InterpolationMethod_Impl_.toString","openfl/display/InterpolationMethod.hx",58,0x1fa1c725)
...
bool InterpolationMethod_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic InterpolationMethod_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_45_fromString)
...
::String InterpolationMethod_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_35fa8dd9a2d72011_58_toString)
HXDLIN(  58)		switch((int)(value)){
            			case (int)0: {
HXLINE(  60)				return HX_("linearRGB",28,a2,44,d9);
            			}
            			break;
            			case (int)1: {
HXLINE(  61)				return HX_("rgb",0d,db,56,00);
            			}
            			break;
            			default:{
