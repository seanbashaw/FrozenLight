...
HX_LOCAL_STACK_FRAME(_hx_pos_86b0f571ca49f8a5_33_fromString,"openfl.display._SpreadMethod.SpreadMethod_Impl_","fromString",0xf9dd3790,"openfl.display._SpreadMethod.SpreadMethod_Impl_.fromString","openfl/display/SpreadMethod.hx",33,0x882c619e)
HX_LOCAL_STACK_FRAME(_hx_pos_86b0f571ca49f8a5_47_toString,"openfl.display._SpreadMethod.SpreadMethod_Impl_","toString",0x8d8a9321,"openfl.display._SpreadMethod.SpreadMethod_Impl_.toString","openfl/display/SpreadMethod.hx",47,0x882c619e)
...
bool SpreadMethod_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic SpreadMethod_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_86b0f571ca49f8a5_33_fromString)
...
::String SpreadMethod_Impl__obj::toString(int value){
            	HX_STACKFRAME(&_hx_pos_86b0f571ca49f8a5_47_toString)
HXDLIN(  47)		switch((int)(value)){
            			case (int)0: {
HXLINE(  49)				return HX_("pad",53,51,55,00);
            			}
            			break;
            			case (int)1: {
HXLINE(  50)				return HX_("reflect",3d,84,29,e9);
            			}
            			break;
            			case (int)2: {
HXLINE(  51)				return HX_("repeat",5b,97,7c,06);
            			}
            			break;
            			default:{
