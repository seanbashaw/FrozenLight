...
HXLINE(  77)		this->_hx___type = HX_("dom",82,42,4c,00);
...
HXLINE( 309)			 ::Dynamic(this->element->__Field(HX_("style",31,a5,1d,84),hx::paccDynamic))->__SetField(HX_("background",ee,93,1d,26),this->_hx___stage->_hx___colorString,hx::paccDynamic);
            		}
            		else {
HXLINE( 313)			 ::Dynamic(this->element->__Field(HX_("style",31,a5,1d,84),hx::paccDynamic))->__SetField(HX_("background",ee,93,1d,26),HX_("none",b8,12,0a,49),hx::paccDynamic);
            		}
