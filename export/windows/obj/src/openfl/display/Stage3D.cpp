...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_78_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",78,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_90_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",90,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_105_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",105,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_110___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",110,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_192___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",192,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_202___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",202,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_212___renderCairo,"openfl.display.Stage3D","__renderCairo",0x4faad7c9,"openfl.display.Stage3D.__renderCairo","openfl/display/Stage3D.hx",212,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_226___renderCanvas,"openfl.display.Stage3D","__renderCanvas",0x69230677,"openfl.display.Stage3D.__renderCanvas","openfl/display/Stage3D.hx",226,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_240___renderDOM,"openfl.display.Stage3D","__renderDOM",0x9069cb83,"openfl.display.Stage3D.__renderDOM","openfl/display/Stage3D.hx",240,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_264___renderGL,"openfl.display.Stage3D","__renderGL",0x25621024,"openfl.display.Stage3D.__renderGL","openfl/display/Stage3D.hx",264,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_284___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",284,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_298___resetContext3DStates,"openfl.display.Stage3D","__resetContext3DStates",0x6c934f5c,"openfl.display.Stage3D.__resetContext3DStates","openfl/display/Stage3D.hx",298,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_312_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",312,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_317_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",317,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_336_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",336,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_341_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",341,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_78_new)
HXLINE(  80)		super::__construct(null());
HXLINE(  82)		this->_hx___x = (int)0;
HXLINE(  83)		this->_hx___y = (int)0;
HXLINE(  85)		this->visible = true;
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
 ...
 ::Dynamic profile = __o_profile.Default(0);
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_90_requestContext3D)
HXLINE(  92)		this->_hx___contextRequested = true;
HXLINE(  94)		if (hx::IsNotNull( this->context3D )) {
HXLINE(  96)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_105_requestContext3DMatchingProfiles)
HXDLIN( 105)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext( ::openfl::display::Stage stage, ::openfl::display::DisplayObjectRenderer renderer){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_110___createContext)
HXLINE( 112)		this->_hx___stage = stage;
HXLINE( 114)		if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 116)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),renderer);
HXLINE( 117)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 119)			bool _hx_tmp = (renderer->_hx___type == HX_("dom",82,42,4c,00));
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_192___dispatchError)
HXLINE( 194)		this->_hx___contextRequested = false;
HXLINE( 195)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_202___dispatchCreate)
HXDLIN( 202)		if (this->_hx___contextRequested) {
HXLINE( 204)			this->_hx___contextRequested = false;
HXLINE( 205)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___renderCairo( ::openfl::display::Stage stage, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_212___renderCairo)
HXLINE( 214)		if (!(this->visible)) {
HXLINE( 214)			return;
            		}
HXLINE( 216)		if (this->_hx___contextRequested) {
HXLINE( 218)			this->_hx___dispatchError();
HXLINE( 219)			this->_hx___contextRequested = false;
            		}
            	}
...
void Stage3D_obj::_hx___renderCanvas( ::openfl::display::Stage stage, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_226___renderCanvas)
HXLINE( 228)		if (!(this->visible)) {
HXLINE( 228)			return;
            		}
HXLINE( 230)		if (this->_hx___contextRequested) {
HXLINE( 232)			this->_hx___dispatchError();
HXLINE( 233)			this->_hx___contextRequested = false;
            		}
            	}
...
void Stage3D_obj::_hx___renderDOM( ::openfl::display::Stage stage, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_240___renderDOM)
HXLINE( 242)		if (!(this->visible)) {
HXLINE( 242)			return;
            		}
HXLINE( 244)		bool _hx_tmp;
HXDLIN( 244)		if (this->_hx___contextRequested) {
HXLINE( 244)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 244)			_hx_tmp = false;
            		}
HXDLIN( 244)		if (_hx_tmp) {
HXLINE( 246)			this->_hx___createContext(stage,renderer);
            		}
HXLINE( 250)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 256)			this->_hx___resetContext3DStates();
            		}
            	}
...
void Stage3D_obj::_hx___renderGL( ::openfl::display::Stage stage, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_264___renderGL)
HXLINE( 266)		if (!(this->visible)) {
HXLINE( 266)			return;
            		}
HXLINE( 268)		bool _hx_tmp;
HXDLIN( 268)		if (this->_hx___contextRequested) {
HXLINE( 268)			_hx_tmp = hx::IsNull( this->context3D );
            		}
            		else {
HXLINE( 268)			_hx_tmp = false;
            		}
HXDLIN( 268)		if (_hx_tmp) {
HXLINE( 270)			this->_hx___createContext(stage,renderer);
            		}
HXLINE( 274)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 276)			this->_hx___resetContext3DStates();
HXLINE( 277)			{
HXLINE( 277)				if (hx::IsNotNull( this->context3D )) {
HXLINE( 277)					renderer->_hx___setBlendMode(null());
HXDLIN( 277)					if (hx::IsNotNull( renderer->_hx___currentShader )) {
HXLINE( 277)						renderer->setShader(null());
HXDLIN( 277)						if (hx::IsNotNull( this->context3D->_hx___program )) {
HXLINE( 277)							this->context3D->_hx___program->_hx___use();
            						}
            					}
            				}
HXDLIN( 277)				if (::openfl::_internal::stage3D::GLUtils_obj::debug) {
HXLINE( 277)					renderer->gl->getError();
            				}
            			}
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_284___resize)
            	}
...
void Stage3D_obj::_hx___resetContext3DStates(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_298___resetContext3DStates)
HXLINE( 301)		this->context3D->_hx___updateBlendFactors();
HXLINE( 302)		this->context3D->_hx___updateBackbufferViewport();
HXLINE( 303)		this->context3D->_hx___updateScissorRectangle();
HXLINE( 304)		this->context3D->_hx___updateDepthAndStencilState();
HXLINE( 305)		this->context3D->_hx___updateCulling();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_312_get_x)
HXDLIN( 312)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_317_set_x)
HXLINE( 319)		if ((this->_hx___x == value)) {
HXLINE( 319)			return value;
            		}
HXLINE( 321)		this->_hx___x = value;
HXLINE( 323)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 325)			this->context3D->_hx___updateBackbufferViewport();
            		}
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_336_get_y)
HXDLIN( 336)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_341_set_y)
HXLINE( 343)		if ((this->_hx___y == value)) {
HXLINE( 343)			return value;
            		}
HXLINE( 345)		this->_hx___y = value;
HXLINE( 347)		if (hx::IsNotNull( this->context3D )) {
HXLINE( 349)			this->context3D->_hx___updateBackbufferViewport();
            		}
