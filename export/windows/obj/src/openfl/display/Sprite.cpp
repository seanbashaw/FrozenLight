...
HX_DEFINE_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_128_new,"openfl.display.Sprite","new",0x3ff0c061,"openfl.display.Sprite.new","openfl/display/Sprite.hx",128,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_160_startDrag,"openfl.display.Sprite","startDrag",0x20ea0c37,"openfl.display.Sprite.startDrag","openfl/display/Sprite.hx",160,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_181_stopDrag,"openfl.display.Sprite","stopDrag",0x4d02dd75,"openfl.display.Sprite.stopDrag","openfl/display/Sprite.hx",181,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_195___getCursor,"openfl.display.Sprite","__getCursor",0x4a69b9ed,"openfl.display.Sprite.__getCursor","openfl/display/Sprite.hx",195,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_200___hitTest,"openfl.display.Sprite","__hitTest",0x895417e6,"openfl.display.Sprite.__hitTest","openfl/display/Sprite.hx",200,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_244___hitTestHitArea,"openfl.display.Sprite","__hitTestHitArea",0x980a9c3a,"openfl.display.Sprite.__hitTestHitArea","openfl/display/Sprite.hx",244,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_271___hitTestMask,"openfl.display.Sprite","__hitTestMask",0x9c046ff2,"openfl.display.Sprite.__hitTestMask","openfl/display/Sprite.hx",271,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_295_get_graphics,"openfl.display.Sprite","get_graphics",0x451134b3,"openfl.display.Sprite.get_graphics","openfl/display/Sprite.hx",295,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_310_get_tabEnabled,"openfl.display.Sprite","get_tabEnabled",0x5c66fc94,"openfl.display.Sprite.get_tabEnabled","openfl/display/Sprite.hx",310,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_317_get_buttonMode,"openfl.display.Sprite","get_buttonMode",0xceb5485d,"openfl.display.Sprite.get_buttonMode","openfl/display/Sprite.hx",317,0xd5438ced)
HX_LOCAL_STACK_FRAME(_hx_pos_781fdaae6ecb7a58_324_set_buttonMode,"openfl.display.Sprite","set_buttonMode",0xeed530d1,"openfl.display.Sprite.set_buttonMode","openfl/display/Sprite.hx",324,0xd5438ced)
namespace openfl{
namespace display{

void Sprite_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_128_new)
HXLINE( 130)		super::__construct();
HXLINE( 132)		this->_hx___buttonMode = false;
HXLINE( 133)		this->useHandCursor = true;
            	}
...
bool lockCenter = __o_lockCenter.Default(false);
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_160_startDrag)
HXDLIN( 160)		if (hx::IsNotNull( this->stage )) {
HXLINE( 162)			this->stage->_hx___startDrag(hx::ObjectPtr<OBJ_>(this),lockCenter,bounds);
            		}
            	}
...
void Sprite_obj::stopDrag(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_181_stopDrag)
HXDLIN( 181)		if (hx::IsNotNull( this->stage )) {
HXLINE( 183)			this->stage->_hx___stopDrag(hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Sprite_obj,stopDrag,(void))
 ...
 ::lime::ui::MouseCursor Sprite_obj::_hx___getCursor(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_195___getCursor)
HXDLIN( 195)		bool _hx_tmp;
HXDLIN( 195)		if (this->_hx___buttonMode) {
HXDLIN( 195)			_hx_tmp = this->useHandCursor;
            		}
            		else {
HXDLIN( 195)			_hx_tmp = false;
            		}
HXDLIN( 195)		if (_hx_tmp) {
HXDLIN( 195)			return ::lime::ui::MouseCursor_obj::POINTER_dyn();
            		}
            		else {
...
bool Sprite_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_200___hitTest)
HXLINE( 202)		bool _hx_tmp;
HXDLIN( 202)		bool _hx_tmp1;
HXDLIN( 202)		if (interactiveOnly) {
HXLINE( 202)			_hx_tmp1 = !(this->mouseEnabled);
            		}
            		else {
HXLINE( 202)			_hx_tmp1 = false;
            		}
HXDLIN( 202)		if (_hx_tmp1) {
HXLINE( 202)			_hx_tmp = !(this->mouseChildren);
            		}
            		else {
...
HXDLIN( 203)		if (!(!(hitObject->get_visible()))) {
HXLINE( 203)			_hx_tmp2 = this->_hx___isMask;
            		}
            		else {
HXLINE( 203)			_hx_tmp2 = true;
            		}
HXDLIN( 203)		if (_hx_tmp2) {
HXLINE( 203)			return this->_hx___hitTestHitArea(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            		}
HXLINE( 204)		bool _hx_tmp3;
HXDLIN( 204)		if (hx::IsNotNull( this->get_mask() )) {
HXLINE( 204)			_hx_tmp3 = !(this->get_mask()->_hx___hitTestMask(x,y));
            		}
            		else {
...
HXLINE( 206)		if (hx::IsNotNull( this->_hx___scrollRect )) {
HXLINE( 208)			 ::openfl::geom::Point point = ::openfl::geom::Point_obj::_hx___pool->get();
HXLINE( 209)			point->setTo(x,y);
HXLINE( 210)			{
HXLINE( 210)				 ::openfl::geom::Matrix _this = this->_hx___getRenderTransform();
HXDLIN( 210)				Float norm = (_this->a * _this->d);
HXDLIN( 210)				Float norm1 = (norm - (_this->b * _this->c));
HXDLIN( 210)				if ((norm1 == (int)0)) {
HXLINE( 210)					point->x = -(_this->tx);
HXDLIN( 210)					point->y = -(_this->ty);
            				}
            				else {
HXLINE( 210)					Float _this1 = _this->c;
HXDLIN( 210)					Float px = (_this1 * (_this->ty - point->y));
HXDLIN( 210)					Float _this2 = _this->d;
HXDLIN( 210)					Float px1 = (((Float)((Float)1.0) / (Float)norm1) * (px + (_this2 * (point->x - _this->tx))));
HXDLIN( 210)					Float _this3 = _this->a;
HXDLIN( 210)					Float _hx_tmp4 = (_this3 * (point->y - _this->ty));
HXDLIN( 210)					Float _this4 = _this->b;
HXDLIN( 210)					point->y = (((Float)((Float)1.0) / (Float)norm1) * (_hx_tmp4 + (_this4 * (_this->tx - point->x))));
HXDLIN( 210)					point->x = px1;
            				}
            			}
HXLINE( 212)			if (!(this->_hx___scrollRect->containsPoint(point))) {
HXLINE( 214)				::openfl::geom::Point_obj::_hx___pool->release(point);
HXLINE( 215)				return this->_hx___hitTestHitArea(x,y,shapeFlag,stack,true,hitObject);
            			}
HXLINE( 219)			::openfl::geom::Point_obj::_hx___pool->release(point);
            		}
HXLINE( 223)		if (this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject)) {
HXLINE( 225)			return interactiveOnly;
            		}
            		else {
HXLINE( 227)			bool _hx_tmp5;
HXDLIN( 227)			bool _hx_tmp6;
HXDLIN( 227)			if (hx::IsNull( this->hitArea )) {
HXLINE( 227)				_hx_tmp6 = hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 227)				_hx_tmp6 = false;
            			}
HXDLIN( 227)			if (_hx_tmp6) {
HXLINE( 227)				 ::openfl::display::Graphics _hx_tmp7 = this->_hx___graphics;
HXDLIN( 227)				_hx_tmp5 = _hx_tmp7->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
HXLINE( 227)				_hx_tmp5 = false;
            			}
HXDLIN( 227)			if (_hx_tmp5) {
HXLINE( 229)				bool _hx_tmp8;
HXDLIN( 229)				if (hx::IsNotNull( stack )) {
HXLINE( 229)					if (!(!(interactiveOnly))) {
HXLINE( 229)						_hx_tmp8 = this->mouseEnabled;
            					}
            					else {
...
HXLINE( 229)					_hx_tmp8 = false;
            				}
HXDLIN( 229)				if (_hx_tmp8) {
HXLINE( 231)					stack->push(hitObject);
            				}
HXLINE( 235)				return true;
            			}
            		}
HXLINE( 239)		return this->_hx___hitTestHitArea(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}
...
bool Sprite_obj::_hx___hitTestHitArea(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_244___hitTestHitArea)
HXLINE( 246)		if (hx::IsNotNull( this->hitArea )) {
HXLINE( 248)			if (!(this->hitArea->mouseEnabled)) {
HXLINE( 250)				this->hitArea->mouseEnabled = true;
HXLINE( 251)				bool hitTest = this->hitArea->_hx___hitTest(x,y,shapeFlag,null(),true,hitObject);
HXLINE( 252)				this->hitArea->mouseEnabled = false;
HXLINE( 254)				bool _hx_tmp;
HXDLIN( 254)				if (hx::IsNotNull( stack )) {
HXLINE( 254)					_hx_tmp = hitTest;
            				}
            				else {
HXLINE( 254)					_hx_tmp = false;
            				}
HXDLIN( 254)				if (_hx_tmp) {
HXLINE( 256)					stack[stack->length] = hitObject;
            				}
HXLINE( 260)				return hitTest;
            			}
            		}
...
bool Sprite_obj::_hx___hitTestMask(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_271___hitTestMask)
HXLINE( 273)		if (this->super::_hx___hitTestMask(x,y)) {
HXLINE( 275)			return true;
            		}
            		else {
HXLINE( 277)			bool _hx_tmp;
HXDLIN( 277)			if (hx::IsNotNull( this->_hx___graphics )) {
HXLINE( 277)				 ::openfl::display::Graphics _hx_tmp1 = this->_hx___graphics;
HXDLIN( 277)				_hx_tmp = _hx_tmp1->_hx___hitTest(x,y,true,this->_hx___getRenderTransform());
            			}
            			else {
...
HXLINE( 283)		return false;
 ...
 ::openfl::display::Graphics Sprite_obj::get_graphics(){
            	HX_GC_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_295_get_graphics)
HXLINE( 297)		if (hx::IsNull( this->_hx___graphics )) {
HXLINE( 299)			this->_hx___graphics =  ::openfl::display::Graphics_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 303)		return this->_hx___graphics;
            	}
...
bool Sprite_obj::get_tabEnabled(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_310_get_tabEnabled)
HXDLIN( 310)		if (hx::IsNull( this->_hx___tabEnabled )) {
HXDLIN( 310)			return this->_hx___buttonMode;
            		}
            		else {
HXDLIN( 310)			return this->_hx___tabEnabled;
            		}
...
bool Sprite_obj::get_buttonMode(){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_317_get_buttonMode)
HXDLIN( 317)		return this->_hx___buttonMode;
            	}
...
bool Sprite_obj::set_buttonMode(bool value){
            	HX_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_324_set_buttonMode)
HXDLIN( 324)		return (this->_hx___buttonMode = value);
            	}
