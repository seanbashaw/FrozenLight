...
HX_DEFINE_STACK_FRAME(_hx_pos_a9a8b88d3857954c_27_new,"openfl.display.Window","new",0x253949cc,"openfl.display.Window.new","openfl/display/Window.hx",27,0x156e59e2)
namespace openfl{
namespace display{

void Window_obj::__construct( ::lime::app::Application application, ::Dynamic attributes){
            	HX_GC_STACKFRAME(&_hx_pos_a9a8b88d3857954c_27_new)
HXLINE(  29)		super::__construct(application,attributes);
HXLINE(  42)		 ::Dynamic _hx_tmp;
HXDLIN(  42)		if (::Reflect_obj::hasField( ::Dynamic(attributes->__Field(HX_("context",ef,95,77,19),hx::paccDynamic)),HX_("background",ee,93,1d,26))) {
HXLINE(  42)			_hx_tmp =  ::Dynamic(attributes->__Field(HX_("context",ef,95,77,19),hx::paccDynamic))->__Field(HX_("background",ee,93,1d,26),hx::paccDynamic);
            		}
            		else {
HXLINE(  42)			_hx_tmp = (int)16777215;
            		}
HXDLIN(  42)		this->stage =  ::openfl::display::Stage_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),_hx_tmp);
HXLINE(  44)		if (::Reflect_obj::hasField(attributes,HX_("parameters",aa,be,7e,51))) {
HXLINE(  46)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(  48)				this->stage->get_loaderInfo()->parameters =  ::Dynamic(attributes->__Field(HX_("parameters",aa,be,7e,51),hx::paccDynamic));
            			}
            			catch( ::Dynamic _hx_e){
...
HXDLIN(  54)		if (::Reflect_obj::hasField(attributes,HX_("resizable",6b,37,50,a9))) {
HXLINE(  54)			_hx_tmp1 = !(( (bool)(attributes->__Field(HX_("resizable",6b,37,50,a9),hx::paccDynamic)) ));
            		}
            		else {
HXLINE(  54)			_hx_tmp1 = false;
            		}
HXDLIN(  54)		if (_hx_tmp1) {
HXLINE(  56)			this->stage->_hx___setLogicalSize(( (int)(attributes->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) ),( (int)(attributes->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) ));
            		}
HXLINE(  60)		application->addModule(this->stage);
            	}
