...
HX_DEFINE_STACK_FRAME(_hx_pos_e7c49b2409073623_1232_new,"openfl.display._MovieClip.FrameSymbolInstance","new",0xd335e789,"openfl.display._MovieClip.FrameSymbolInstance.new","openfl/display/MovieClip.hx",1232,0x2b84738a)
namespace openfl{
namespace display{
...
void FrameSymbolInstance_obj::__construct(int initFrame,int initFrameObjectID,int characterID,int depth, ::openfl::display::DisplayObject displayObject,int clipDepth){
            	HX_STACKFRAME(&_hx_pos_e7c49b2409073623_1232_new)
HXLINE(1234)		this->initFrame = initFrame;
HXLINE(1235)		this->initFrameObjectID = initFrameObjectID;
HXLINE(1236)		this->characterID = characterID;
HXLINE(1237)		this->depth = depth;
HXLINE(1238)		this->displayObject = displayObject;
HXLINE(1239)		this->clipDepth = clipDepth;
            	}
