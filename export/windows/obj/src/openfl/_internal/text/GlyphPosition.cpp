...
HXLINE(  23)		this->glyph = glyph;
HXLINE(  24)		this->advance = advance;
HXLINE(  26)		if (hx::IsNotNull( offset )) {
HXLINE(  28)			this->offset = offset;
            		}
            		else {
HXLINE(  32)			this->offset =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null());
            		}
            	}
