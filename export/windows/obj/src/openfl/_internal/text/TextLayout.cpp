...
HX_DEFINE_STACK_FRAME(_hx_pos_76ab009fbf19bc61_23_new,"openfl._internal.text.TextLayout","new",0xc6d6c63a,"openfl._internal.text.TextLayout.new","openfl/_internal/text/TextLayout.hx",23,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_93___create,"openfl._internal.text.TextLayout","__create",0x1fb06602,"openfl._internal.text.TextLayout.__create","openfl/_internal/text/TextLayout.hx",93,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_105___position,"openfl._internal.text.TextLayout","__position",0x581ded2f,"openfl._internal.text.TextLayout.__position","openfl/_internal/text/TextLayout.hx",105,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_194_get_positions,"openfl._internal.text.TextLayout","get_positions",0xe8c451db,"openfl._internal.text.TextLayout.get_positions","openfl/_internal/text/TextLayout.hx",194,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_210_get_direction,"openfl._internal.text.TextLayout","get_direction",0x28b2c070,"openfl._internal.text.TextLayout.get_direction","openfl/_internal/text/TextLayout.hx",210,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_215_set_direction,"openfl._internal.text.TextLayout","set_direction",0x6db8a27c,"openfl._internal.text.TextLayout.set_direction","openfl/_internal/text/TextLayout.hx",215,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_227_set_font,"openfl._internal.text.TextLayout","set_font",0x6d4a06b2,"openfl._internal.text.TextLayout.set_font","openfl/_internal/text/TextLayout.hx",227,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_238_get_glyphs,"openfl._internal.text.TextLayout","get_glyphs",0x88cb4276,"openfl._internal.text.TextLayout.get_glyphs","openfl/_internal/text/TextLayout.hx",238,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_255_get_language,"openfl._internal.text.TextLayout","get_language",0x8c8bb347,"openfl._internal.text.TextLayout.get_language","openfl/_internal/text/TextLayout.hx",255,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_260_set_language,"openfl._internal.text.TextLayout","set_language",0xa184d6bb,"openfl._internal.text.TextLayout.set_language","openfl/_internal/text/TextLayout.hx",260,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_274_get_script,"openfl._internal.text.TextLayout","get_script",0x21d2973a,"openfl._internal.text.TextLayout.get_script","openfl/_internal/text/TextLayout.hx",274,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_279_set_script,"openfl._internal.text.TextLayout","set_script",0x255035ae,"openfl._internal.text.TextLayout.set_script","openfl/_internal/text/TextLayout.hx",279,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_291_set_size,"openfl._internal.text.TextLayout","set_size",0x75dd49a4,"openfl._internal.text.TextLayout.set_size","openfl/_internal/text/TextLayout.hx",291,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_76ab009fbf19bc61_302_set_text,"openfl._internal.text.TextLayout","set_text",0x76837590,"openfl._internal.text.TextLayout.set_text","openfl/_internal/text/TextLayout.hx",302,0x21621597)
...
::String language = __o_language.Default(HX_HCSTRING("en","\x69","\x58","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_23_new)
HXLINE(  58)		this->letterSpacing = ((Float)0);
HXLINE(  78)		this->set_text(text);
HXLINE(  79)		this->set_font(font);
HXLINE(  80)		this->set_size(size);
HXLINE(  81)		this->_hx___direction = direction;
HXLINE(  82)		this->_hx___script = script;
HXLINE(  83)		this->_hx___language = language;
HXLINE(  85)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  86)		this->_hx___dirty = true;
HXLINE(  88)		this->_hx___create(this->_hx___direction,this->_hx___script,this->_hx___language);
            	}
...
void TextLayout_obj::_hx___create(int direction,::String script,::String language){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_93___create)
HXLINE(  95)		if ((language.length != (int)4)) {
HXLINE(  95)			return;
            		}
...
HXDLIN(  98)			switch((int)(direction)){
            				case (int)4: {
HXLINE(  98)					value = (int)4;
            				}
            				break;
            				case (int)5: {
HXLINE(  98)					value = (int)5;
            				}
            				break;
            				case (int)6: {
HXLINE(  98)					value = (int)6;
            				}
            				break;
            				case (int)7: {
HXLINE(  98)					value = (int)7;
            				}
            				break;
            				default:{
HXLINE(  98)					value = (int)0;
            				}
            			}
...
void TextLayout_obj::_hx___position(){
            	HX_GC_STACKFRAME(&_hx_pos_76ab009fbf19bc61_105___position)
HXLINE( 107)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 110)		bool _hx_tmp;
HXDLIN( 110)		bool _hx_tmp1;
HXDLIN( 110)		bool _hx_tmp2;
HXDLIN( 110)		if (hx::IsNotNull( this->text )) {
HXLINE( 110)			_hx_tmp2 = (this->text != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 110)			_hx_tmp2 = false;
            		}
HXDLIN( 110)		if (_hx_tmp2) {
HXLINE( 110)			_hx_tmp1 = hx::IsNotNull( this->font );
            		}
            		else {
HXLINE( 110)			_hx_tmp1 = false;
            		}
HXDLIN( 110)		if (_hx_tmp1) {
HXLINE( 110)			_hx_tmp = hx::IsNotNull( this->font->src );
            		}
            		else {
HXLINE( 110)			_hx_tmp = false;
            		}
HXDLIN( 110)		if (_hx_tmp) {
HXLINE( 112)			if (hx::IsNull( this->_hx___buffer )) {
HXLINE( 114)				this->_hx___buffer = ::haxe::io::Bytes_obj::alloc((this->text.length * (int)5));
            			}
HXLINE( 119)			if (hx::IsNotEq( this->_hx___font,this->font )) {
HXLINE( 121)				this->_hx___font = this->font;
HXLINE( 123)				this->font->_hx___setSize(this->size);
HXLINE( 124)				this->_hx___hbFont = ::lime::text::harfbuzz::_HBFTFont::HBFTFont_Impl__obj::_new(this->font);
HXLINE( 126)				if (this->autoHint) {
HXLINE( 128)					::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_ft_font_set_load_flags(hx::DynamicPtr(this->_hx___hbFont),(int)32);
            				}
            			}
            			else {
HXLINE( 134)				this->font->_hx___setSize(this->size);
            			}
HXLINE( 138)			if (hx::IsNull( this->_hx___hbBuffer )) {
HXLINE( 140)				this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
            			}
            			else {
HXLINE( 144)				::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::reset(this->_hx___hbBuffer);
            			}
HXLINE( 148)			{
HXLINE( 148)				 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN( 148)				int value;
HXDLIN( 148)				switch((int)(this->get_direction())){
            					case (int)4: {
HXLINE( 148)						value = (int)4;
            					}
            					break;
            					case (int)5: {
HXLINE( 148)						value = (int)5;
            					}
            					break;
            					case (int)6: {
HXLINE( 148)						value = (int)6;
            					}
            					break;
            					case (int)7: {
HXLINE( 148)						value = (int)7;
            					}
            					break;
            					default:{
HXLINE( 148)						value = (int)0;
            					}
            				}
HXDLIN( 148)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(hx::DynamicPtr(this1),value);
            			}
HXLINE( 149)			{
HXLINE( 149)				 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN( 149)				::String this3 = this->get_script();
HXDLIN( 149)				int value1 = (int)1517910393;
HXDLIN( 149)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(hx::DynamicPtr(this2),value1);
            			}
HXLINE( 150)			{
HXLINE( 150)				 ::Dynamic this4 = this->_hx___hbBuffer;
HXDLIN( 150)				 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(this->get_language());
HXDLIN( 150)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(hx::DynamicPtr(this4),hx::DynamicPtr(value2));
            			}
HXLINE( 151)			{
HXLINE( 151)				int value3 = (int)2;
HXDLIN( 151)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_cluster_level(hx::DynamicPtr(this->_hx___hbBuffer),value3);
            			}
HXLINE( 152)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF8(this->_hx___hbBuffer,this->text,(int)0,(int)-1);
HXLINE( 154)			::lime::text::harfbuzz::HB_obj::shape(this->_hx___hbFont,this->_hx___hbBuffer,null());
HXLINE( 156)			::Array< ::Dynamic> _info = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 157)			::Array< ::Dynamic> _positions = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
HXLINE( 159)			 ::lime::text::harfbuzz::HBGlyphInfo info;
HXDLIN( 159)			 ::lime::text::harfbuzz::HBGlyphPosition position;
HXLINE( 160)			int lastCluster = (int)-1;
HXLINE( 162)			{
HXLINE( 162)				int _g1 = (int)0;
HXDLIN( 162)				int _g = _info->length;
HXDLIN( 162)				while((_g1 < _g)){
HXLINE( 162)					_g1 = (_g1 + (int)1);
HXDLIN( 162)					int i = (_g1 - (int)1);
HXLINE( 164)					info = _info->__get(i).StaticCast<  ::lime::text::harfbuzz::HBGlyphInfo >();
HXLINE( 165)					position = _positions->__get(i).StaticCast<  ::lime::text::harfbuzz::HBGlyphPosition >();
HXLINE( 167)					{
HXLINE( 167)						int _g3 = (lastCluster + (int)1);
HXDLIN( 167)						int _g2 = info->cluster;
HXDLIN( 167)						while((_g3 < _g2)){
HXLINE( 167)							_g3 = (_g3 + (int)1);
HXDLIN( 167)							int j = (_g3 - (int)1);
HXLINE( 171)							::Array< ::Dynamic> _hx_tmp3 = this->get_positions();
HXDLIN( 171)							 ::lime::math::Vector2 _hx_tmp4 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(int)0,(int)0);
HXDLIN( 171)							_hx_tmp3->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,(int)0,_hx_tmp4, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(int)0,(int)0)));
            						}
            					}
HXLINE( 175)					::Array< ::Dynamic> _hx_tmp5 = this->get_positions();
HXDLIN( 175)					int info1 = info->codepoint;
HXDLIN( 175)					Float _hx_tmp6 = (((Float)position->xAdvance / (Float)(int)64) + this->letterSpacing);
HXDLIN( 175)					 ::lime::math::Vector2 _hx_tmp7 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp6,((Float)position->yAdvance / (Float)(int)64));
HXDLIN( 175)					Float _hx_tmp8 = ((Float)position->xOffset / (Float)(int)64);
HXDLIN( 175)					_hx_tmp5->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp7, ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp8,((Float)position->yOffset / (Float)(int)64))));
HXLINE( 176)					lastCluster = info->cluster;
            				}
            			}
            		}
            	}
...
::Array< ::Dynamic> TextLayout_obj::get_positions(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_194_get_positions)
HXLINE( 196)		if (this->_hx___dirty) {
HXLINE( 198)			this->_hx___dirty = false;
HXLINE( 199)			this->_hx___position();
            		}
HXLINE( 203)		return this->positions;
            	}
...
int TextLayout_obj::get_direction(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_210_get_direction)
HXDLIN( 210)		return this->_hx___direction;
            	}
...
int TextLayout_obj::set_direction(int value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_215_set_direction)
HXLINE( 217)		if ((value == this->_hx___direction)) {
HXLINE( 217)			return value;
            		}
HXLINE( 219)		this->_hx___direction = value;
HXLINE( 220)		this->_hx___dirty = true;
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_227_set_font)
HXLINE( 229)		if (hx::IsEq( value,this->font )) {
HXLINE( 229)			return value;
            		}
HXLINE( 231)		this->font = value;
...
::Array< int > TextLayout_obj::get_glyphs(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_238_get_glyphs)
HXLINE( 240)		::Array< int > glyphs = ::Array_obj< int >::__new(0);
HXLINE( 242)		{
HXLINE( 242)			int _g = (int)0;
HXDLIN( 242)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 242)			while((_g < _g1->length)){
HXLINE( 242)				 ::openfl::_internal::text::GlyphPosition position = _g1->__get(_g).StaticCast<  ::openfl::_internal::text::GlyphPosition >();
HXDLIN( 242)				_g = (_g + (int)1);
HXLINE( 244)				glyphs->push(position->glyph);
            			}
            		}
...
::String TextLayout_obj::get_language(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_255_get_language)
HXDLIN( 255)		return this->_hx___language;
            	}
...
::String TextLayout_obj::set_language(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_260_set_language)
HXLINE( 262)		if ((value == this->_hx___language)) {
HXLINE( 262)			return value;
            		}
HXLINE( 264)		this->_hx___language = value;
...
::String TextLayout_obj::get_script(){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_274_get_script)
HXDLIN( 274)		return this->_hx___script;
            	}
...
::String TextLayout_obj::set_script(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_279_set_script)
HXLINE( 281)		if ((value == this->_hx___script)) {
HXLINE( 281)			return value;
            		}
HXLINE( 283)		this->_hx___script = value;
...
int TextLayout_obj::set_size(int value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_291_set_size)
HXLINE( 293)		if ((value == this->size)) {
HXLINE( 293)			return value;
            		}
HXLINE( 295)		this->size = value;
...
::String TextLayout_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_302_set_text)
HXLINE( 304)		if ((value == this->text)) {
HXLINE( 304)			return value;
            		}
HXLINE( 306)		this->text = value;
HXLINE( 307)		this->_hx___dirty = true;
...
HXDLIN(  47)		FT_LOAD_TARGET_NORMAL = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_76ab009fbf19bc61_48_boot)
HXDLIN(  48)		FT_LOAD_TARGET_LIGHT = (int)0;
            	}
}
