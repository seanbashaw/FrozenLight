...
HXLINE(1125)							{
HXLINE(1125)								 ::lime::math::Matrix3 _this = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::tempMatrix3;
HXDLIN(1125)								_this->a = t1;
HXDLIN(1125)								_this->b = t2;
HXDLIN(1125)								_this->c = t3;
HXDLIN(1125)								_this->d = t4;
HXDLIN(1125)								_this->tx = dx;
HXDLIN(1125)								_this->ty = dy;
            							}
