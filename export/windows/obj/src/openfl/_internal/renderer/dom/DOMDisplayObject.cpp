...
HX_LOCAL_STACK_FRAME(_hx_pos_861188b285f627bd_20_clear,"openfl._internal.renderer.dom.DOMDisplayObject","clear",0x6073f245,"openfl._internal.renderer.dom.DOMDisplayObject.clear","openfl/_internal/renderer/dom/DOMDisplayObject.hx",20,0xeb6cef58)
HX_LOCAL_STACK_FRAME(_hx_pos_861188b285f627bd_29_render,"openfl._internal.renderer.dom.DOMDisplayObject","render",0x02818b9e,"openfl._internal.renderer.dom.DOMDisplayObject.render","openfl/_internal/renderer/dom/DOMDisplayObject.hx",29,0xeb6cef58)
namespace openfl{
namespace _internal{
namespace renderer{
namespace dom{
...
void DOMDisplayObject_obj::clear( ::openfl::display::DisplayObject displayObject, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_861188b285f627bd_20_clear)
            	}
...
void DOMDisplayObject_obj::render( ::openfl::display::DisplayObject displayObject, ::openfl::display::DOMRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_861188b285f627bd_29_render)
            	}
