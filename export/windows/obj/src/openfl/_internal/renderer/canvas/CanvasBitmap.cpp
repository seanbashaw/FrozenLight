...
HX_LOCAL_STACK_FRAME(_hx_pos_2b98ee52b048188b_20_render,"openfl._internal.renderer.canvas.CanvasBitmap","render",0x768a0e62,"openfl._internal.renderer.canvas.CanvasBitmap.render","openfl/_internal/renderer/canvas/CanvasBitmap.hx",20,0x093d64fa)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasBitmap_obj::render( ::openfl::display::Bitmap bitmap, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_2b98ee52b048188b_20_render)
            	}
