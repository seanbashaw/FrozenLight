...
HX_LOCAL_STACK_FRAME(_hx_pos_eb9e22bc341d245c_20_render,"openfl._internal.renderer.canvas.CanvasDisplayObject","render",0x4f6734b6,"openfl._internal.renderer.canvas.CanvasDisplayObject.render","openfl/_internal/renderer/canvas/CanvasDisplayObject.hx",20,0x74b28f52)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasDisplayObject_obj::render( ::openfl::display::DisplayObject displayObject, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_eb9e22bc341d245c_20_render)
            	}
