...
HX_LOCAL_STACK_FRAME(_hx_pos_aa6154e001ea54c5_23_render,"openfl._internal.stage3D.opengl.GLStage3D","render",0x1308fc2a,"openfl._internal.stage3D.opengl.GLStage3D.render","openfl/_internal/stage3D/opengl/GLStage3D.hx",23,0x8ea52802)
namespace openfl{
namespace _internal{
namespace stage3D{
namespace opengl{
...
void GLStage3D_obj::render( ::openfl::display::Stage3D stage3D, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_aa6154e001ea54c5_23_render)
HXLINE(  25)		if (hx::IsNotNull( stage3D->context3D )) {
HXLINE(  27)			renderer->_hx___setBlendMode(null());
HXLINE(  29)			if (hx::IsNotNull( renderer->_hx___currentShader )) {
HXLINE(  31)				renderer->setShader(null());
HXLINE(  33)				if (hx::IsNotNull( stage3D->context3D->_hx___program )) {
HXLINE(  35)					stage3D->context3D->_hx___program->_hx___use();
            				}
            			}
            		}
HXLINE(  43)		if (::openfl::_internal::stage3D::GLUtils_obj::debug) {
HXLINE(  45)			renderer->gl->getError();
            		}
            	}
