...
HX_LOCAL_STACK_FRAME(_hx_pos_4c968ed63f4ef91b_26_create,"openfl._internal.stage3D.opengl.GLVideoTexture","create",0x562bceb5,"openfl._internal.stage3D.opengl.GLVideoTexture.create","openfl/_internal/stage3D/opengl/GLVideoTexture.hx",26,0x30240f6b)
HX_LOCAL_STACK_FRAME(_hx_pos_4c968ed63f4ef91b_60_getTexture,"openfl._internal.stage3D.opengl.GLVideoTexture","getTexture",0xd13f871e,"openfl._internal.stage3D.opengl.GLVideoTexture.getTexture","openfl/_internal/stage3D/opengl/GLVideoTexture.hx",60,0x30240f6b)
namespace openfl{
namespace _internal{
namespace stage3D{
namespace opengl{
...
void GLVideoTexture_obj::create( ::openfl::display3D::textures::VideoTexture videoTexture, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_4c968ed63f4ef91b_26_create)
HXLINE(  29)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = renderer->_hx___context->webgl;
HXLINE(  33)		videoTexture->_hx___textureTarget = gl->TEXTURE_2D;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(GLVideoTexture_obj,create,(void))
 ...
 ::lime::graphics::opengl::GLObject GLVideoTexture_obj::getTexture( ::openfl::display3D::textures::VideoTexture videoTexture, ::openfl::display::OpenGLRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_4c968ed63f4ef91b_60_getTexture)
HXDLIN(  60)		return videoTexture->_hx___textureID;
            	}
