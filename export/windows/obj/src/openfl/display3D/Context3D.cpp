...
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_116_clear,"openfl.display3D.Context3D","clear",0xf8808186,"openfl.display3D.Context3D.clear","openfl/display3D/Context3D.hx",116,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_123_configureBackBuffer,"openfl.display3D.Context3D","configureBackBuffer",0x7210edc6,"openfl.display3D.Context3D.configureBackBuffer","openfl/display3D/Context3D.hx",123,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_130_createCubeTexture,"openfl.display3D.Context3D","createCubeTexture",0xbb69e843,"openfl.display3D.Context3D.createCubeTexture","openfl/display3D/Context3D.hx",130,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_137_createIndexBuffer,"openfl.display3D.Context3D","createIndexBuffer",0x3b80e18f,"openfl.display3D.Context3D.createIndexBuffer","openfl/display3D/Context3D.hx",137,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_144_createProgram,"openfl.display3D.Context3D","createProgram",0x0b5753e1,"openfl.display3D.Context3D.createProgram","openfl/display3D/Context3D.hx",144,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_151_createRectangleTexture,"openfl.display3D.Context3D","createRectangleTexture",0x8720f36f,"openfl.display3D.Context3D.createRectangleTexture","openfl/display3D/Context3D.hx",151,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_158_createTexture,"openfl.display3D.Context3D","createTexture",0xb63ed238,"openfl.display3D.Context3D.createTexture","openfl/display3D/Context3D.hx",158,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_165_createVertexBuffer,"openfl.display3D.Context3D","createVertexBuffer",0x49fb9507,"openfl.display3D.Context3D.createVertexBuffer","openfl/display3D/Context3D.hx",165,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_175_createVideoTexture,"openfl.display3D.Context3D","createVideoTexture",0x922f1723,"openfl.display3D.Context3D.createVideoTexture","openfl/display3D/Context3D.hx",175,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_183_dispose,"openfl.display3D.Context3D","dispose",0x8ad040d8,"openfl.display3D.Context3D.dispose","openfl/display3D/Context3D.hx",183,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_188_drawToBitmapData,"openfl.display3D.Context3D","drawToBitmapData",0x474f45df,"openfl.display3D.Context3D.drawToBitmapData","openfl/display3D/Context3D.hx",188,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_197_drawTriangles,"openfl.display3D.Context3D","drawTriangles",0x0d837500,"openfl.display3D.Context3D.drawTriangles","openfl/display3D/Context3D.hx",197,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_213_present,"openfl.display3D.Context3D","present",0x095ffb34,"openfl.display3D.Context3D.present","openfl/display3D/Context3D.hx",213,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_220_setBlendFactors,"openfl.display3D.Context3D","setBlendFactors",0x86d16c6e,"openfl.display3D.Context3D.setBlendFactors","openfl/display3D/Context3D.hx",220,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_227_setColorMask,"openfl.display3D.Context3D","setColorMask",0xad4f5d14,"openfl.display3D.Context3D.setColorMask","openfl/display3D/Context3D.hx",227,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_234_setCulling,"openfl.display3D.Context3D","setCulling",0x39687055,"openfl.display3D.Context3D.setCulling","openfl/display3D/Context3D.hx",234,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_241_setDepthTest,"openfl.display3D.Context3D","setDepthTest",0x2d08b41a,"openfl.display3D.Context3D.setDepthTest","openfl/display3D/Context3D.hx",241,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_246_setProgram,"openfl.display3D.Context3D","setProgram",0xd9d9d869,"openfl.display3D.Context3D.setProgram","openfl/display3D/Context3D.hx",246,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_259_setProgramConstantsFromByteArray,"openfl.display3D.Context3D","setProgramConstantsFromByteArray",0xd8990de1,"openfl.display3D.Context3D.setProgramConstantsFromByteArray","openfl/display3D/Context3D.hx",259,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_270_setProgramConstantsFromMatrix,"openfl.display3D.Context3D","setProgramConstantsFromMatrix",0x29e843d1,"openfl.display3D.Context3D.setProgramConstantsFromMatrix","openfl/display3D/Context3D.hx",270,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_275_setProgramConstantsFromVector,"openfl.display3D.Context3D","setProgramConstantsFromVector",0x057dbe53,"openfl.display3D.Context3D.setProgramConstantsFromVector","openfl/display3D/Context3D.hx",275,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_286_setRenderToBackBuffer,"openfl.display3D.Context3D","setRenderToBackBuffer",0x6095d693,"openfl.display3D.Context3D.setRenderToBackBuffer","openfl/display3D/Context3D.hx",286,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_293_setRenderToTexture,"openfl.display3D.Context3D","setRenderToTexture",0x25c5d54f,"openfl.display3D.Context3D.setRenderToTexture","openfl/display3D/Context3D.hx",293,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_300_setSamplerStateAt,"openfl.display3D.Context3D","setSamplerStateAt",0x9f8ad1f7,"openfl.display3D.Context3D.setSamplerStateAt","openfl/display3D/Context3D.hx",300,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_307_setScissorRectangle,"openfl.display3D.Context3D","setScissorRectangle",0x712bb5ee,"openfl.display3D.Context3D.setScissorRectangle","openfl/display3D/Context3D.hx",307,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_314_setStencilActions,"openfl.display3D.Context3D","setStencilActions",0x1fe08e1c,"openfl.display3D.Context3D.setStencilActions","openfl/display3D/Context3D.hx",314,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_321_setStencilReferenceValue,"openfl.display3D.Context3D","setStencilReferenceValue",0xaa284f67,"openfl.display3D.Context3D.setStencilReferenceValue","openfl/display3D/Context3D.hx",321,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_328_setTextureAt,"openfl.display3D.Context3D","setTextureAt",0x38d4bfd3,"openfl.display3D.Context3D.setTextureAt","openfl/display3D/Context3D.hx",328,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_335_setVertexBufferAt,"openfl.display3D.Context3D","setVertexBufferAt",0xbb32fa52,"openfl.display3D.Context3D.setVertexBufferAt","openfl/display3D/Context3D.hx",335,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_342___updateBackbufferViewport,"openfl.display3D.Context3D","__updateBackbufferViewport",0x1ffcf0dd,"openfl.display3D.Context3D.__updateBackbufferViewport","openfl/display3D/Context3D.hx",342,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_349___updateBlendFactors,"openfl.display3D.Context3D","__updateBlendFactors",0x00141f63,"openfl.display3D.Context3D.__updateBlendFactors","openfl/display3D/Context3D.hx",349,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_356___updateCulling,"openfl.display3D.Context3D","__updateCulling",0x37aca180,"openfl.display3D.Context3D.__updateCulling","openfl/display3D/Context3D.hx",356,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_363___updateDepthAndStencilState,"openfl.display3D.Context3D","__updateDepthAndStencilState",0x7fba6d19,"openfl.display3D.Context3D.__updateDepthAndStencilState","openfl/display3D/Context3D.hx",363,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_370___updateScissorRectangle,"openfl.display3D.Context3D","__updateScissorRectangle",0x17db8763,"openfl.display3D.Context3D.__updateScissorRectangle","openfl/display3D/Context3D.hx",370,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_384_get_enableErrorChecking,"openfl.display3D.Context3D","get_enableErrorChecking",0x0dbc654f,"openfl.display3D.Context3D.get_enableErrorChecking","openfl/display3D/Context3D.hx",384,0xc899cbb9)
HX_LOCAL_STACK_FRAME(_hx_pos_15a405ef6f3df6a7_389_set_enableErrorChecking,"openfl.display3D.Context3D","set_enableErrorChecking",0x101dce5b,"openfl.display3D.Context3D.set_enableErrorChecking","openfl/display3D/Context3D.hx",389,0xc899cbb9)
...
HXLINE(  69)		this->_hx___culling = (int)3;
...
HXLINE( 107)		this->_hx___renderer = renderer;
HXLINE( 109)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::create(hx::ObjectPtr<OBJ_>(this));
            	}
...
int mask = __o_mask.Default(7);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_116_clear)
HXDLIN( 116)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::clear(hx::ObjectPtr<OBJ_>(this),red,green,blue,alpha,depth,stencil,mask);
            	}
...
bool wantsBestResolutionOnBrowserZoom = __o_wantsBestResolutionOnBrowserZoom.Default(false);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_123_configureBackBuffer)
HXDLIN( 123)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::configureBackBuffer(hx::ObjectPtr<OBJ_>(this),width,height,antiAlias,enableDepthAndStencil,wantsBestResolution,wantsBestResolutionOnBrowserZoom);
            	}
...
int streamingLevels = __o_streamingLevels.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_130_createCubeTexture)
HXDLIN( 130)		return  ::openfl::display3D::textures::CubeTexture_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),size,format,optimizeForRenderToTexture,streamingLevels);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(Context3D_obj,createCubeTexture,return )
 ...
 ::Dynamic bufferUsage = __o_bufferUsage.Default(1);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_137_createIndexBuffer)
HXDLIN( 137)		return  ::openfl::display3D::IndexBuffer3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),numIndices,bufferUsage);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Context3D_obj,createIndexBuffer,return )
 ...
 ::openfl::display3D::Program3D Context3D_obj::createProgram(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_144_createProgram)
HXDLIN( 144)		return  ::openfl::display3D::Program3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Context3D_obj,createProgram,return )
 ...
 ::openfl::display3D::textures::RectangleTexture Context3D_obj::createRectangleTexture(int width,int height, ::Dynamic format,bool optimizeForRenderToTexture){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_151_createRectangleTexture)
HXDLIN( 151)		return  ::openfl::display3D::textures::RectangleTexture_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),width,height,::openfl::display3D::_Context3DTextureFormat::Context3DTextureFormat_Impl__obj::toString(format),optimizeForRenderToTexture);
            	}
...
int streamingLevels = __o_streamingLevels.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_158_createTexture)
HXDLIN( 158)		return  ::openfl::display3D::textures::Texture_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),width,height,format,optimizeForRenderToTexture,streamingLevels);
            	}
...
HX_DEFINE_DYNAMIC_FUNC5(Context3D_obj,createTexture,return )
 ...
 ::Dynamic bufferUsage = __o_bufferUsage.Default(1);
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_165_createVertexBuffer)
HXDLIN( 165)		return  ::openfl::display3D::VertexBuffer3D_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),numVertices,data32PerVertex,::openfl::display3D::_Context3DBufferUsage::Context3DBufferUsage_Impl__obj::toString(bufferUsage));
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Context3D_obj,createVertexBuffer,return )
 ...
 ::openfl::display3D::textures::VideoTexture Context3D_obj::createVideoTexture(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_175_createVideoTexture)
HXDLIN( 175)		HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("Video textures are not supported on this platform",02,cd,86,ca),null()));
...
bool recreate = __o_recreate.Default(true);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_183_dispose)
HXDLIN( 183)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::dispose(hx::ObjectPtr<OBJ_>(this),recreate);
            	}
...
void Context3D_obj::drawToBitmapData( ::openfl::display::BitmapData destination){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_188_drawToBitmapData)
HXLINE( 190)		if (hx::IsNull( destination )) {
HXLINE( 190)			return;
            		}
HXLINE( 192)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::drawToBitmapData(hx::ObjectPtr<OBJ_>(this),destination);
            	}
...
int numTriangles = __o_numTriangles.Default(-1);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_197_drawTriangles)
HXLINE( 199)		if (hx::IsNull( this->_hx___program )) {
HXLINE( 201)			return;
            		}
HXLINE( 205)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::drawTriangles(hx::ObjectPtr<OBJ_>(this),indexBuffer,firstIndex,numTriangles);
            	}
...
void Context3D_obj::present(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_213_present)
HXDLIN( 213)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::present(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Context3D_obj::setBlendFactors( ::Dynamic sourceFactor, ::Dynamic destinationFactor){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_220_setBlendFactors)
HXDLIN( 220)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setBlendFactors(hx::ObjectPtr<OBJ_>(this),sourceFactor,destinationFactor);
            	}
...
void Context3D_obj::setColorMask(bool red,bool green,bool blue,bool alpha){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_227_setColorMask)
HXDLIN( 227)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setColorMask(hx::ObjectPtr<OBJ_>(this),red,green,blue,alpha);
            	}
...
void Context3D_obj::setCulling( ::Dynamic triangleFaceToCull){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_234_setCulling)
HXDLIN( 234)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setCulling(hx::ObjectPtr<OBJ_>(this),triangleFaceToCull);
            	}
...
void Context3D_obj::setDepthTest(bool depthMask, ::Dynamic passCompareMode){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_241_setDepthTest)
HXDLIN( 241)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setDepthTest(hx::ObjectPtr<OBJ_>(this),depthMask,passCompareMode);
            	}
...
void Context3D_obj::setProgram( ::openfl::display3D::Program3D program){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_246_setProgram)
HXLINE( 248)		if (hx::IsNull( program )) {
HXLINE( 250)			HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            		}
HXLINE( 254)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgram(hx::ObjectPtr<OBJ_>(this),program);
            	}
...
void Context3D_obj::setProgramConstantsFromByteArray( ::Dynamic programType,int firstRegister,int numRegisters, ::openfl::utils::ByteArrayData data,int byteArrayOffset){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_259_setProgramConstantsFromByteArray)
HXLINE( 261)		if ((numRegisters == (int)0)) {
HXLINE( 261)			return;
            		}
HXLINE( 263)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgramConstantsFromByteArray(hx::ObjectPtr<OBJ_>(this),programType,firstRegister,numRegisters,data,byteArrayOffset);
            	}
...
bool transposedMatrix = __o_transposedMatrix.Default(false);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_270_setProgramConstantsFromMatrix)
HXDLIN( 270)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgramConstantsFromMatrix(hx::ObjectPtr<OBJ_>(this),programType,firstRegister,matrix,transposedMatrix);
            	}
...
int numRegisters = __o_numRegisters.Default(-1);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_275_setProgramConstantsFromVector)
HXLINE( 277)		if ((numRegisters == (int)0)) {
HXLINE( 277)			return;
            		}
HXLINE( 279)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setProgramConstantsFromVector(hx::ObjectPtr<OBJ_>(this),programType,firstRegister,data,numRegisters);
            	}
...
void Context3D_obj::setRenderToBackBuffer(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_286_setRenderToBackBuffer)
HXDLIN( 286)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setRenderToBackBuffer(hx::ObjectPtr<OBJ_>(this));
            	}
...
int surfaceSelector = __o_surfaceSelector.Default(0);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_293_setRenderToTexture)
HXDLIN( 293)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setRenderToTexture(hx::ObjectPtr<OBJ_>(this),texture,enableDepthAndStencil,antiAlias,surfaceSelector);
            	}
...
void Context3D_obj::setSamplerStateAt(int sampler, ::Dynamic wrap, ::Dynamic filter, ::Dynamic mipfilter){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_300_setSamplerStateAt)
HXDLIN( 300)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setSamplerStateAt(hx::ObjectPtr<OBJ_>(this),sampler,wrap,filter,mipfilter);
            	}
...
void Context3D_obj::setScissorRectangle( ::openfl::geom::Rectangle rectangle){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_307_setScissorRectangle)
HXDLIN( 307)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setScissorRectangle(hx::ObjectPtr<OBJ_>(this),rectangle);
            	}
...
void Context3D_obj::setStencilActions( ::Dynamic __o_triangleFace, ::Dynamic __o_compareMode, ::Dynamic __o_actionOnBothPass, ::Dynamic __o_actionOnDepthFail, ::Dynamic __o_actionOnDepthPassStencilFail){
 ...
 ::Dynamic actionOnDepthPassStencilFail = __o_actionOnDepthPassStencilFail.Default(5);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_314_setStencilActions)
HXDLIN( 314)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setStencilActions(hx::ObjectPtr<OBJ_>(this),triangleFace,compareMode,actionOnBothPass,actionOnDepthFail,actionOnDepthPassStencilFail);
            	}
...
int writeMask = __o_writeMask.Default(255);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_321_setStencilReferenceValue)
HXDLIN( 321)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setStencilReferenceValue(hx::ObjectPtr<OBJ_>(this),referenceValue,readMask,writeMask);
            	}
...
void Context3D_obj::setTextureAt(int sampler, ::openfl::display3D::textures::TextureBase texture){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_328_setTextureAt)
HXDLIN( 328)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setTextureAt(hx::ObjectPtr<OBJ_>(this),sampler,texture);
            	}
...
int bufferOffset = __o_bufferOffset.Default(0);
 ::Dynamic format = __o_format.Default(4);
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_335_setVertexBufferAt)
HXDLIN( 335)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setVertexBufferAt(hx::ObjectPtr<OBJ_>(this),index,buffer,bufferOffset,format);
            	}
...
void Context3D_obj::_hx___updateBackbufferViewport(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_342___updateBackbufferViewport)
HXDLIN( 342)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::_hx___updateBackbufferViewportTEMP(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Context3D_obj::_hx___updateBlendFactors(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_349___updateBlendFactors)
HXDLIN( 349)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::_hx___updateBlendFactorsTEMP(hx::ObjectPtr<OBJ_>(this));
            	}


HX_DEFINE_DYNAMIC_FUNC0(Context3D_obj,_hx___updateBlendFactors,(void))

void Context3D_obj::_hx___updateCulling(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_356___updateCulling)
HXDLIN( 356)		this->setCulling(this->_hx___culling);
            	}


HX_DEFINE_DYNAMIC_FUNC0(Context3D_obj,_hx___updateCulling,(void))

void Context3D_obj::_hx___updateDepthAndStencilState(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_363___updateDepthAndStencilState)
HXDLIN( 363)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::_hx___updateDepthAndStencilStateTEMP(hx::ObjectPtr<OBJ_>(this));
            	}
...
void Context3D_obj::_hx___updateScissorRectangle(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_370___updateScissorRectangle)
HXDLIN( 370)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::_hx___updateScissorRectangleTEMP(hx::ObjectPtr<OBJ_>(this));
            	}
...
bool Context3D_obj::get_enableErrorChecking(){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_384_get_enableErrorChecking)
HXDLIN( 384)		return this->_hx___enableErrorChecking;
            	}
...
bool Context3D_obj::set_enableErrorChecking(bool value){
            	HX_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_389_set_enableErrorChecking)
HXLINE( 391)		::openfl::_internal::stage3D::opengl::GLContext3D_obj::setEnableErrorChecking(value);
HXLINE( 392)		return (this->_hx___enableErrorChecking = value);
            	}
...
void Context3D_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_hx___culling,"__culling");
...
void Context3D_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_hx___culling,"__culling");
...
hx::Val Context3D_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__culling") ) { return hx::Val( _hx___culling ); }
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"__updateCulling") ) { return hx::Val( _hx___updateCulling_dyn() ); }
		break;
	case 16:
...
hx::Val Context3D_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__culling") ) { _hx___culling=inValue.Cast<  ::Dynamic >(); return inValue; }
...
void Context3D_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("__culling","\x50","\x33","\xd6","\xd4"));
...
static hx::StorageInfo Context3D_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(Context3D_obj,_hx___culling),HX_HCSTRING("__culling","\x50","\x33","\xd6","\xd4")},
...
static ::String Context3D_obj_sMemberFields[] = {
	...
	HX_HCSTRING("__culling","\x50","\x33","\xd6","\xd4"),
	...
	HX_HCSTRING("__updateCulling","\x47","\x80","\xa8","\xa6"),
