...
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_68_dispose,"openfl.display3D.Program3D","dispose",0x556f61ad,"openfl.display3D.Program3D.dispose","openfl/display3D/Program3D.hx",68,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_75_upload,"openfl.display3D.Program3D","upload",0x91a244b3,"openfl.display3D.Program3D.upload","openfl/display3D/Program3D.hx",75,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_80___flush,"openfl.display3D.Program3D","__flush",0x071c9cb2,"openfl.display3D.Program3D.__flush","openfl/display3D/Program3D.hx",80,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_90___getSamplerState,"openfl.display3D.Program3D","__getSamplerState",0x4314690d,"openfl.display3D.Program3D.__getSamplerState","openfl/display3D/Program3D.hx",90,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_97___markDirty,"openfl.display3D.Program3D","__markDirty",0xf012f9b3,"openfl.display3D.Program3D.__markDirty","openfl/display3D/Program3D.hx",97,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_112___setPositionScale,"openfl.display3D.Program3D","__setPositionScale",0x1baf80f1,"openfl.display3D.Program3D.__setPositionScale","openfl/display3D/Program3D.hx",112,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_123___setSamplerState,"openfl.display3D.Program3D","__setSamplerState",0x3edfe619,"openfl.display3D.Program3D.__setSamplerState","openfl/display3D/Program3D.hx",123,0x0a985b04)
HX_LOCAL_STACK_FRAME(_hx_pos_536f681b10c755a2_130___use,"openfl.display3D.Program3D","__use",0xea326eb5,"openfl.display3D.Program3D.__use","openfl/display3D/Program3D.hx",130,0x0a985b04)
namespace openfl{
namespace display3D{
...
HXLINE(  59)		this->_hx___alphaSamplerEnabled = ::Array_obj< ::Dynamic>::__new();
HXLINE(  61)		bool fixed = null();
HXDLIN(  61)		this->_hx___samplerStates =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,(int)8,fixed,null(),true);
            	}
...
void Program3D_obj::dispose(){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_68_dispose)
HXDLIN(  68)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::dispose(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ));
            	}
...
void Program3D_obj::upload( ::openfl::utils::ByteArrayData vertexProgram, ::openfl::utils::ByteArrayData fragmentProgram){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_75_upload)
HXDLIN(  75)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::upload(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),vertexProgram,fragmentProgram);
            	}
...
void Program3D_obj::_hx___flush(){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_80___flush)
HXLINE(  82)		this->_hx___vertexUniformMap->flush();
HXLINE(  83)		this->_hx___fragmentUniformMap->flush();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Program3D_obj,_hx___flush,(void))
 ...
 ::openfl::_internal::stage3D::SamplerState Program3D_obj::_hx___getSamplerState(int sampler){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_90___getSamplerState)
HXDLIN(  90)		return this->_hx___samplerStates->get(sampler).StaticCast<  ::openfl::_internal::stage3D::SamplerState >();
            	}
...
void Program3D_obj::_hx___markDirty(bool isVertex,int index,int count){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_97___markDirty)
HXDLIN(  97)		if (isVertex) {
HXLINE(  99)			this->_hx___vertexUniformMap->markDirty(index,count);
            		}
            		else {
HXLINE( 103)			this->_hx___fragmentUniformMap->markDirty(index,count);
            		}
            	}
...
void Program3D_obj::_hx___setPositionScale( ::lime::utils::ArrayBufferView positionScale){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_112___setPositionScale)
HXDLIN( 112)		if (hx::IsNotNull( this->_hx___positionScale )) {
HXLINE( 114)			::openfl::_internal::stage3D::opengl::GLProgram3D_obj::setPositionScale(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ),positionScale);
            		}
            	}
...
void Program3D_obj::_hx___setSamplerState(int sampler, ::openfl::_internal::stage3D::SamplerState state){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_123___setSamplerState)
HXDLIN( 123)		this->_hx___samplerStates->set(sampler,state).StaticCast<  ::openfl::_internal::stage3D::SamplerState >();
            	}
...
void Program3D_obj::_hx___use(){
            	HX_STACKFRAME(&_hx_pos_536f681b10c755a2_130___use)
HXDLIN( 130)		::openfl::_internal::stage3D::opengl::GLProgram3D_obj::use(hx::ObjectPtr<OBJ_>(this),( ( ::openfl::display::OpenGLRenderer)(this->_hx___context->_hx___renderer) ));
            	}
