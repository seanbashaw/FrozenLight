...
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_120_stop,"openfl.media.SoundChannel","stop",0x090ae1f4,"openfl.media.SoundChannel.stop","openfl/media/SoundChannel.hx",120,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_132___dispose,"openfl.media.SoundChannel","__dispose",0x8d7f924d,"openfl.media.SoundChannel.__dispose","openfl/media/SoundChannel.hx",132,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_145___updateTransform,"openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",145,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_157_get_position,"openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",157,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_166_set_position,"openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",166,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_178_get_soundTransform,"openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",178,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_183_set_soundTransform,"openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",183,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_224_source_onComplete,"openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",224,0xa4290000)
namespace openfl{
namespace media{
...
HXLINE(  86)		super::__construct(hx::ObjectPtr<OBJ_>(this));
HXLINE(  88)		this->leftPeak = (int)1;
HXLINE(  89)		this->rightPeak = (int)1;
HXLINE(  91)		if (hx::IsNotNull( soundTransform )) {
HXLINE(  93)			this->_hx___soundTransform = soundTransform;
            		}
            		else {
HXLINE(  97)			this->_hx___soundTransform =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
            		}
HXLINE( 101)		if (hx::IsNotNull( source )) {
HXLINE( 103)			this->_hx___source = source;
HXLINE( 104)			this->_hx___source->onComplete->add(this->source_onComplete_dyn(),null(),null());
HXLINE( 105)			this->_hx___isValid = true;
HXLINE( 107)			this->_hx___source->play();
            		}
HXLINE( 111)		::openfl::media::SoundMixer_obj::_hx___registerSoundChannel(hx::ObjectPtr<OBJ_>(this));
            	}
...
void SoundChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_120_stop)
HXLINE( 122)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 124)		if (!(this->_hx___isValid)) {
HXLINE( 124)			return;
            		}
HXLINE( 126)		this->_hx___source->stop();
HXLINE( 127)		this->_hx___dispose();
            	}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_132___dispose)
HXLINE( 134)		if (!(this->_hx___isValid)) {
HXLINE( 134)			return;
            		}
HXLINE( 136)		this->_hx___source->onComplete->remove(this->source_onComplete_dyn());
HXLINE( 137)		this->_hx___source->dispose();
HXLINE( 138)		this->_hx___isValid = false;
            	}
...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_145___updateTransform)
HXDLIN( 145)		this->set_soundTransform(this->get_soundTransform());
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_157_get_position)
HXLINE( 159)		if (!(this->_hx___isValid)) {
HXLINE( 159)			return (int)0;
            		}
HXLINE( 161)		int _hx_tmp = this->_hx___source->get_currentTime();
HXDLIN( 161)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_166_set_position)
HXLINE( 168)		if (!(this->_hx___isValid)) {
HXLINE( 168)			return (int)0;
            		}
HXLINE( 170)		 ::lime::media::AudioSource _hx_tmp = this->_hx___source;
HXDLIN( 170)		int _hx_tmp1 = ::Std_obj::_hx_int(value);
HXDLIN( 170)		_hx_tmp->set_currentTime((_hx_tmp1 - this->_hx___source->offset));
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_178_get_soundTransform)
HXDLIN( 178)		return this->_hx___soundTransform->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_183_set_soundTransform)
HXLINE( 185)		if (hx::IsNotNull( value )) {
HXLINE( 187)			this->_hx___soundTransform->pan = value->pan;
HXLINE( 188)			this->_hx___soundTransform->volume = value->volume;
HXLINE( 190)			Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
...
HXLINE( 195)			Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 197)			if (this->_hx___isValid) {
HXLINE( 199)				this->_hx___source->set_gain(volume);
HXLINE( 201)				 ::lime::math::Vector4 position = this->_hx___source->get_position();
HXLINE( 202)				position->x = pan;
HXLINE( 203)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
HXLINE( 204)				this->_hx___source->set_position(position);
...
void SoundChannel_obj::source_onComplete(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_224_source_onComplete)
HXLINE( 226)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 228)		this->_hx___dispose();
HXLINE( 229)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
