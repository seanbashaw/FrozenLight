...
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_161_new,"openfl.geom.ColorTransform","new",0x35d8b8af,"openfl.geom.ColorTransform.new","openfl/geom/ColorTransform.hx",161,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_186_concat,"openfl.geom.ColorTransform","concat",0x6a83fc25,"openfl.geom.ColorTransform.concat","openfl/geom/ColorTransform.hx",186,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_203_toString,"openfl.geom.ColorTransform","toString",0xe65269fd,"openfl.geom.ColorTransform.toString","openfl/geom/ColorTransform.hx",203,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_210___clone,"openfl.geom.ColorTransform","__clone",0x6d82280c,"openfl.geom.ColorTransform.__clone","openfl/geom/ColorTransform.hx",210,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_215___copyFrom,"openfl.geom.ColorTransform","__copyFrom",0x0c92ce70,"openfl.geom.ColorTransform.__copyFrom","openfl/geom/ColorTransform.hx",215,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_230___combine,"openfl.geom.ColorTransform","__combine",0x74bf08ee,"openfl.geom.ColorTransform.__combine","openfl/geom/ColorTransform.hx",230,0x850de941)
...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_259___invert,"openfl.geom.ColorTransform","__invert",0xf5ebeb87,"openfl.geom.ColorTransform.__invert","openfl/geom/ColorTransform.hx",259,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_275___equals,"openfl.geom.ColorTransform","__equals",0x1605f2b0,"openfl.geom.ColorTransform.__equals","openfl/geom/ColorTransform.hx",275,0x850de941)
...
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_287___setArrays,"openfl.geom.ColorTransform","__setArrays",0x7ef0862b,"openfl.geom.ColorTransform.__setArrays","openfl/geom/ColorTransform.hx",287,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_310_get_color,"openfl.geom.ColorTransform","get_color",0x07485b49,"openfl.geom.ColorTransform.get_color","openfl/geom/ColorTransform.hx",310,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_315_set_color,"openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",315,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_330___toLimeColorMatrix,"openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",330,0x850de941)
namespace openfl{
namespace geom{
...
Float alphaOffset = __o_alphaOffset.Default(0);
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_161_new)
HXLINE( 163)		this->redMultiplier = redMultiplier;
HXLINE( 164)		this->greenMultiplier = greenMultiplier;
HXLINE( 165)		this->blueMultiplier = blueMultiplier;
HXLINE( 166)		this->alphaMultiplier = alphaMultiplier;
HXLINE( 167)		this->redOffset = redOffset;
HXLINE( 168)		this->greenOffset = greenOffset;
HXLINE( 169)		this->blueOffset = blueOffset;
HXLINE( 170)		this->alphaOffset = alphaOffset;
            	}
...
void ColorTransform_obj::concat( ::openfl::geom::ColorTransform second){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_186_concat)
...
HX_DEFINE_DYNAMIC_FUNC0(ColorTransform_obj,toString,return )
 ...
 ::openfl::geom::ColorTransform ColorTransform_obj::_hx___clone(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_210___clone)
HXDLIN( 210)		return  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,this->redMultiplier,this->greenMultiplier,this->blueMultiplier,this->alphaMultiplier,this->redOffset,this->greenOffset,this->blueOffset,this->alphaOffset);
            	}
...
void ColorTransform_obj::_hx___copyFrom( ::openfl::geom::ColorTransform ct){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_215___copyFrom)
HXLINE( 217)		this->redMultiplier = ct->redMultiplier;
HXLINE( 218)		this->greenMultiplier = ct->greenMultiplier;
HXLINE( 219)		this->blueMultiplier = ct->blueMultiplier;
HXLINE( 220)		this->alphaMultiplier = ct->alphaMultiplier;
HXLINE( 222)		this->redOffset = ct->redOffset;
HXLINE( 223)		this->greenOffset = ct->greenOffset;
HXLINE( 224)		this->blueOffset = ct->blueOffset;
HXLINE( 225)		this->alphaOffset = ct->alphaOffset;
            	}
...
void ColorTransform_obj::_hx___combine( ::openfl::geom::ColorTransform ct){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_230___combine)
...
HXLINE( 247)		this->redMultiplier = (int)1;
HXLINE( 248)		this->greenMultiplier = (int)1;
HXLINE( 249)		this->blueMultiplier = (int)1;
HXLINE( 250)		this->alphaMultiplier = (int)1;
HXLINE( 251)		this->redOffset = (int)0;
HXLINE( 252)		this->greenOffset = (int)0;
HXLINE( 253)		this->blueOffset = (int)0;
HXLINE( 254)		this->alphaOffset = (int)0;
            	}
...
void ColorTransform_obj::_hx___invert(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_259___invert)
HXLINE( 261)		this->redMultiplier = ((Float)(int)1 / (Float)this->redMultiplier);
HXLINE( 262)		this->greenMultiplier = ((Float)(int)1 / (Float)this->greenMultiplier);
HXLINE( 263)		this->blueMultiplier = ((Float)(int)1 / (Float)this->blueMultiplier);
HXLINE( 264)		this->alphaMultiplier = ((Float)(int)1 / (Float)this->alphaMultiplier);
...
bool ColorTransform_obj::_hx___equals( ::openfl::geom::ColorTransform ct, ::Dynamic __o_skipAlphaMultiplier){
 ::Dynamic skipAlphaMultiplier = __o_skipAlphaMultiplier.Default(false);
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_275___equals)
...
HXDLIN( 275)		if (hx::IsNotNull( ct )) {
HXDLIN( 275)			_hx_tmp6 = (this->redMultiplier == ct->redMultiplier);
            		}
            		else {
HXDLIN( 275)			_hx_tmp6 = false;
            		}
HXDLIN( 275)		if (_hx_tmp6) {
HXDLIN( 275)			_hx_tmp5 = (this->greenMultiplier == ct->greenMultiplier);
            		}
            		else {
HXDLIN( 275)			_hx_tmp5 = false;
            		}
HXDLIN( 275)		if (_hx_tmp5) {
HXDLIN( 275)			_hx_tmp4 = (this->blueMultiplier == ct->blueMultiplier);
            		}
            		else {
HXDLIN( 275)			_hx_tmp4 = false;
            		}
HXDLIN( 275)		if (_hx_tmp4) {
HXDLIN( 275)			if (!(skipAlphaMultiplier)) {
HXDLIN( 275)				_hx_tmp3 = (this->alphaMultiplier == ct->alphaMultiplier);
            			}
            			else {
HXDLIN( 275)				_hx_tmp3 = true;
            			}
            		}
            		else {
HXDLIN( 275)			_hx_tmp3 = false;
            		}
HXDLIN( 275)		if (_hx_tmp3) {
HXDLIN( 275)			_hx_tmp2 = (this->redOffset == ct->redOffset);
            		}
            		else {
HXDLIN( 275)			_hx_tmp2 = false;
            		}
HXDLIN( 275)		if (_hx_tmp2) {
HXDLIN( 275)			_hx_tmp1 = (this->greenOffset == ct->greenOffset);
            		}
            		else {
HXDLIN( 275)			_hx_tmp1 = false;
            		}
HXDLIN( 275)		if (_hx_tmp1) {
HXDLIN( 275)			_hx_tmp = (this->blueOffset == ct->blueOffset);
            		}
            		else {
HXDLIN( 275)			_hx_tmp = false;
            		}
HXDLIN( 275)		if (_hx_tmp) {
HXDLIN( 275)			return (this->alphaOffset == ct->alphaOffset);
            		}
            		else {
...
HXDLIN( 282)		if ((this->redMultiplier == (int)1)) {
HXDLIN( 282)			_hx_tmp5 = (this->greenMultiplier == (int)1);
            		}
            		else {
HXDLIN( 282)			_hx_tmp5 = false;
            		}
HXDLIN( 282)		if (_hx_tmp5) {
HXDLIN( 282)			_hx_tmp4 = (this->blueMultiplier == (int)1);
            		}
            		else {
HXDLIN( 282)			_hx_tmp4 = false;
            		}
HXDLIN( 282)		if (_hx_tmp4) {
HXDLIN( 282)			_hx_tmp3 = (this->alphaMultiplier == (int)1);
            		}
            		else {
HXDLIN( 282)			_hx_tmp3 = false;
            		}
HXDLIN( 282)		if (_hx_tmp3) {
HXDLIN( 282)			_hx_tmp2 = (this->redOffset == (int)0);
            		}
            		else {
HXDLIN( 282)			_hx_tmp2 = false;
            		}
HXDLIN( 282)		if (_hx_tmp2) {
HXDLIN( 282)			_hx_tmp1 = (this->greenOffset == (int)0);
            		}
            		else {
HXDLIN( 282)			_hx_tmp1 = false;
            		}
HXDLIN( 282)		if (_hx_tmp1) {
HXDLIN( 282)			_hx_tmp = (this->blueOffset == (int)0);
            		}
            		else {
HXDLIN( 282)			_hx_tmp = false;
            		}
HXDLIN( 282)		if (_hx_tmp) {
HXDLIN( 282)			return (this->alphaOffset == (int)0);
            		}
            		else {
...
void ColorTransform_obj::_hx___setArrays(::Array< Float > colorMultipliers,::Array< Float > colorOffsets){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_287___setArrays)
HXLINE( 289)		colorMultipliers[(int)0] = this->redMultiplier;
HXLINE( 290)		colorMultipliers[(int)1] = this->greenMultiplier;
HXLINE( 291)		colorMultipliers[(int)2] = this->blueMultiplier;
HXLINE( 292)		colorMultipliers[(int)3] = this->alphaMultiplier;
HXLINE( 293)		colorOffsets[(int)0] = this->redOffset;
HXLINE( 294)		colorOffsets[(int)1] = this->greenOffset;
HXLINE( 295)		colorOffsets[(int)2] = this->blueOffset;
HXLINE( 296)		colorOffsets[(int)3] = this->alphaOffset;
            	}
...
int ColorTransform_obj::get_color(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_310_get_color)
HXDLIN( 310)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
HXDLIN( 310)		int _hx_tmp1 = ((int)_hx_tmp | (int)((int)::Std_obj::_hx_int(this->greenOffset) << (int)(int)8));
HXDLIN( 310)		return ((int)_hx_tmp1 | (int)::Std_obj::_hx_int(this->blueOffset));
            	}
...
int ColorTransform_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_315_set_color)
HXLINE( 317)		this->redOffset = ((int)((int)value >> (int)(int)16) & (int)(int)255);
HXLINE( 318)		this->greenOffset = ((int)((int)value >> (int)(int)8) & (int)(int)255);
HXLINE( 319)		this->blueOffset = ((int)value & (int)(int)255);
HXLINE( 321)		this->redMultiplier = (int)0;
HXLINE( 322)		this->greenMultiplier = (int)0;
HXLINE( 323)		this->blueMultiplier = (int)0;
HXLINE( 325)		return this->get_color();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ColorTransform_obj,set_color,return )
 ...
 ::lime::utils::ArrayBufferView ColorTransform_obj::_hx___toLimeColorMatrix(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_330___toLimeColorMatrix)
HXLINE( 332)		if (hx::IsNull( ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix )) {
HXLINE( 334)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)20,(int)8);
HXDLIN( 334)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix = this1;
            		}
HXLINE( 338)		{
...
HXDLIN( 339)			Float val1 = ((Float)this->redOffset / (Float)(int)255);
HXDLIN( 339)			::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)16),val1);
            		}
HXLINE( 340)		{
...
HXDLIN( 340)			::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)24),val2);
            		}
HXLINE( 341)		{
HXLINE( 341)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 341)			Float val3 = ((Float)this->greenOffset / (Float)(int)255);
HXDLIN( 341)			::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)36),val3);
            		}
HXLINE( 342)		{
...
HXDLIN( 342)			::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)48),val4);
            		}
HXLINE( 343)		{
HXLINE( 343)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 343)			Float val5 = ((Float)this->blueOffset / (Float)(int)255);
HXDLIN( 343)			::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)56),val5);
            		}
HXLINE( 344)		{
...
HXDLIN( 344)			::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)72),val6);
            		}
HXLINE( 345)		{
HXLINE( 345)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 345)			Float val7 = ((Float)this->alphaOffset / (Float)(int)255);
HXDLIN( 345)			::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)76),val7);
            		}
