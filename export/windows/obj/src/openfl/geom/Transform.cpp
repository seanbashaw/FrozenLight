...
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_204_get_concatenatedMatrix,"openfl.geom.Transform","get_concatenatedMatrix",0x352d276f,"openfl.geom.Transform.get_concatenatedMatrix","openfl/geom/Transform.hx",204,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_217_get_matrix,"openfl.geom.Transform","get_matrix",0x80c3ba80,"openfl.geom.Transform.get_matrix","openfl/geom/Transform.hx",217,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_230_set_matrix,"openfl.geom.Transform","set_matrix",0x844158f4,"openfl.geom.Transform.set_matrix","openfl/geom/Transform.hx",230,0xf4f475e6)
HX_LOCAL_STACK_FRAME(_hx_pos_c4822148baac23ea_253_get_matrix3D,"openfl.geom.Transform","get_matrix3D",0x05078731,"openfl.geom.Transform.get_matrix3D","openfl/geom/Transform.hx",253,0xf4f475e6)
...
HXLINE( 192)		if (!(this->_hx___colorTransform->_hx___equals(value,null()))) {
HXLINE( 194)			this->_hx___colorTransform->_hx___copyFrom(value);
HXLINE( 195)			{
HXLINE( 195)				 ::openfl::display::DisplayObject _this = this->_hx___displayObject;
HXDLIN( 195)				if (!(_this->_hx___renderDirty)) {
HXLINE( 195)					_this->_hx___renderDirty = true;
HXDLIN( 195)					_this->_hx___setParentRenderDirty();
            				}
            			}
            		}
HXLINE( 199)		return this->_hx___colorTransform;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_colorTransform,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_concatenatedMatrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_204_get_concatenatedMatrix)
HXLINE( 206)		if (this->_hx___hasMatrix) {
HXLINE( 208)			return this->_hx___displayObject->_hx___getWorldTransform()->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_concatenatedMatrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::get_matrix(){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_217_get_matrix)
HXLINE( 219)		if (this->_hx___hasMatrix) {
HXLINE( 221)			return this->_hx___displayObject->_hx___transform->clone();
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Transform_obj,get_matrix,return )
 ...
 ::openfl::geom::Matrix Transform_obj::set_matrix( ::openfl::geom::Matrix value){
            	HX_STACKFRAME(&_hx_pos_c4822148baac23ea_230_set_matrix)
HXLINE( 232)		if (hx::IsNull( value )) {
HXLINE( 234)			this->_hx___hasMatrix = false;
HXLINE( 235)			return null();
            		}
HXLINE( 239)		this->_hx___hasMatrix = true;
HXLINE( 240)		this->_hx___hasMatrix3D = false;
HXLINE( 242)		if (hx::IsNotNull( this->_hx___displayObject )) {
HXLINE( 244)			this->_hx___setTransform(value->a,value->b,value->c,value->d,value->tx,value->ty);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Transform_obj,set_matrix,return )
 ...
 ::openfl::geom::Matrix3D Transform_obj::get_matrix3D(){
            	HX_GC_STACKFRAME(&_hx_pos_c4822148baac23ea_253_get_matrix3D)
HXLINE( 255)		if (this->_hx___hasMatrix3D) {
HXLINE( 257)			 ::openfl::geom::Matrix matrix = this->_hx___displayObject->_hx___transform;
HXLINE( 258)			::Array< Float > a = ::Array_obj< Float >::__new(16)->init(0,matrix->a)->init(1,matrix->b)->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,matrix->c)->init(5,matrix->d)->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)1.0))->init(11,((Float)0.0))->init(12,matrix->tx)->init(13,matrix->ty)->init(14,((Float)0.0))->init(15,((Float)1.0));
HXDLIN( 258)			int length = null();
HXDLIN( 258)			bool fixed = null();
HXDLIN( 258)			 ::openfl::_Vector::FloatVector vector =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,null(),true);
HXDLIN( 258)			{
HXLINE( 258)				int _g1 = (int)0;
HXDLIN( 258)				int _g = a->length;
HXDLIN( 258)				while((_g1 < _g)){
HXLINE( 258)					_g1 = (_g1 + (int)1);
HXDLIN( 258)					int i = (_g1 - (int)1);
HXDLIN( 258)					vector->set(i,a->__get(i));
            				}
            			}
HXDLIN( 258)			return  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,vector);
            		}
...
HXLINE( 276)		this->_hx___hasMatrix = false;
HXLINE( 277)		this->_hx___hasMatrix3D = true;
HXLINE( 279)		Float _hx_tmp = value->rawData->get((int)0);
HXDLIN( 279)		Float _hx_tmp1 = value->rawData->get((int)1);
HXDLIN( 279)		Float _hx_tmp2 = value->rawData->get((int)5);
HXDLIN( 279)		Float _hx_tmp3 = value->rawData->get((int)6);
HXDLIN( 279)		Float _hx_tmp4 = value->rawData->get((int)12);
HXDLIN( 279)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,value->rawData->get((int)13));
...
HXLINE( 290)			Float scaleX = ((Float)0.0);
HXLINE( 291)			Float scaleY = ((Float)0.0);
HXLINE( 293)			if ((b == (int)0)) {
HXLINE( 295)				scaleX = a;
            			}
            			else {
HXLINE( 299)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 303)			if ((c == (int)0)) {
HXLINE( 305)				scaleY = a;
            			}
            			else {
HXLINE( 309)				scaleY = ::Math_obj::sqrt(((c * c) + (d * d)));
            			}
HXLINE( 313)			this->_hx___displayObject->_hx___scaleX = scaleX;
HXLINE( 314)			this->_hx___displayObject->_hx___scaleY = scaleY;
HXLINE( 316)			Float rotation = ((Float)(int)180 / (Float)::Math_obj::PI);
HXDLIN( 316)			Float rotation1 = ((rotation * ::Math_obj::atan2(d,c)) - (int)90);
HXLINE( 318)			if ((rotation1 != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 320)				this->_hx___displayObject->_hx___rotation = rotation1;
HXLINE( 321)				Float radians = (rotation1 * ((Float)::Math_obj::PI / (Float)(int)180));
...
HXLINE( 327)			this->_hx___displayObject->_hx___transform->a = a;
HXLINE( 328)			this->_hx___displayObject->_hx___transform->b = b;
HXLINE( 329)			this->_hx___displayObject->_hx___transform->c = c;
HXLINE( 330)			this->_hx___displayObject->_hx___transform->d = d;
HXLINE( 331)			this->_hx___displayObject->_hx___transform->tx = tx;
HXLINE( 332)			this->_hx___displayObject->_hx___transform->ty = ty;
