...
HX_DEFINE_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_44_new,"openfl.filters.BitmapFilter","new",0x22686a4a,"openfl.filters.BitmapFilter.new","openfl/filters/BitmapFilter.hx",44,0x1697f5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_66_clone,"openfl.filters.BitmapFilter","clone",0x8c417bc7,"openfl.filters.BitmapFilter.clone","openfl/filters/BitmapFilter.hx",66,0x1697f5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_73___applyFilter,"openfl.filters.BitmapFilter","__applyFilter",0xc6240310,"openfl.filters.BitmapFilter.__applyFilter","openfl/filters/BitmapFilter.hx",73,0x1697f5a4)
HX_LOCAL_STACK_FRAME(_hx_pos_f182c9f42f2f4da3_81___initShader,"openfl.filters.BitmapFilter","__initShader",0x9b1b6e4b,"openfl.filters.BitmapFilter.__initShader","openfl/filters/BitmapFilter.hx",81,0x1697f5a4)
namespace openfl{
namespace filters{

void BitmapFilter_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_44_new)
HXLINE(  46)		this->_hx___bottomExtension = (int)0;
HXLINE(  47)		this->_hx___leftExtension = (int)0;
HXLINE(  48)		this->_hx___needSecondBitmapData = true;
HXLINE(  49)		this->_hx___numShaderPasses = (int)0;
HXLINE(  50)		this->_hx___preserveObject = false;
HXLINE(  51)		this->_hx___rightExtension = (int)0;
HXLINE(  52)		this->_hx___shaderBlendMode = (int)10;
HXLINE(  53)		this->_hx___topExtension = (int)0;
            	}
...
bool BitmapFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter BitmapFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_66_clone)
HXDLIN(  66)		return  ::openfl::filters::BitmapFilter_obj::__alloc( HX_CTX );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BitmapFilter_obj,clone,return )
 ...
 ::openfl::display::BitmapData BitmapFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_73___applyFilter)
HXDLIN(  73)		return sourceBitmapData;
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(BitmapFilter_obj,_hx___applyFilter,return )
 ...
 ::openfl::display::Shader BitmapFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass){
            	HX_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_81___initShader)
