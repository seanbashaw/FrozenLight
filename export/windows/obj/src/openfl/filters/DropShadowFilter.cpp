...
HX_DEFINE_STACK_FRAME(_hx_pos_786269b8d678908e_234_new,"openfl.filters.DropShadowFilter","new",0xf784b84a,"openfl.filters.DropShadowFilter.new","openfl/filters/DropShadowFilter.hx",234,0x048fdea4)
HX_LOCAL_STACK_FRAME(_hx_pos_786269b8d678908e_264_clone,"openfl.filters.DropShadowFilter","clone",0x1b8d49c7,"openfl.filters.DropShadowFilter.clone","openfl/filters/DropShadowFilter.hx",264,0x048fdea4)
HX_LOCAL_STACK_FRAME(_hx_pos_786269b8d678908e_269___applyFilter,"openfl.filters.DropShadowFilter","__applyFilter",0x5aedd110,"openfl.filters.DropShadowFilter.__applyFilter","openfl/filters/DropShadowFilter.hx",269,0x048fdea4)
...
bool hideObject = __o_hideObject.Default(false);
            	HX_STACKFRAME(&_hx_pos_786269b8d678908e_234_new)
HXLINE( 236)		super::__construct();
HXLINE( 238)		this->_hx___offsetX = (int)0;
HXLINE( 239)		this->_hx___offsetY = (int)0;
HXLINE( 241)		this->_hx___distance = distance;
HXLINE( 242)		this->_hx___angle = angle;
HXLINE( 243)		this->_hx___color = color;
HXLINE( 244)		this->_hx___alpha = alpha;
HXLINE( 245)		this->_hx___blurX = blurX;
HXLINE( 246)		this->_hx___blurY = blurY;
HXLINE( 247)		this->_hx___strength = strength;
HXLINE( 248)		this->_hx___quality = quality;
HXLINE( 249)		this->_hx___inner = inner;
HXLINE( 250)		this->_hx___knockout = knockout;
HXLINE( 251)		this->_hx___hideObject = hideObject;
HXLINE( 253)		this->_hx___updateSize();
HXLINE( 255)		this->_hx___needSecondBitmapData = true;
HXLINE( 256)		this->_hx___preserveObject = !(this->_hx___hideObject);
...
bool DropShadowFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter DropShadowFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_786269b8d678908e_264_clone)
HXDLIN( 264)		return  ::openfl::filters::DropShadowFilter_obj::__alloc( HX_CTX ,this->_hx___distance,this->_hx___angle,this->_hx___color,this->_hx___alpha,this->_hx___blurX,this->_hx___blurY,this->_hx___strength,this->_hx___quality,this->_hx___inner,this->_hx___knockout,this->_hx___hideObject);
            	}
 ...
 ::openfl::display::BitmapData DropShadowFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_GC_STACKFRAME(&_hx_pos_786269b8d678908e_269___applyFilter)
...
HXLINE( 276)		 ::openfl::geom::Rectangle sourceBitmapData1 = sourceBitmapData->rect;
HXDLIN( 276)		sourceBitmapData->colorTransform(sourceBitmapData1, ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)0,this->_hx___alpha,r,g,b,(int)0));
HXLINE( 278)		 ::openfl::geom::Point destPoint1 = destPoint;
HXDLIN( 278)		destPoint1->x = (destPoint1->x + this->_hx___offsetX);
HXLINE( 279)		 ::openfl::geom::Point destPoint2 = destPoint;
HXDLIN( 279)		destPoint2->y = (destPoint2->y + this->_hx___offsetY);
HXLINE( 281)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 281)		 ::lime::graphics::Image sourceBitmapData2 = sourceBitmapData->image;
HXDLIN( 281)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 281)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 281)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData2,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,this->_hx___strength);
HXLINE( 283)		if (hx::IsEq( finalImage2,bitmapData->image )) {
