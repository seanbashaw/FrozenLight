...
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_172_new,"openfl.filters.BlurFilter","new",0x2ff6acc2,"openfl.filters.BlurFilter.new","openfl/filters/BlurFilter.hx",172,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_189_clone,"openfl.filters.BlurFilter","clone",0xcbbf4c3f,"openfl.filters.BlurFilter.clone","openfl/filters/BlurFilter.hx",189,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_194___applyFilter,"openfl.filters.BlurFilter","__applyFilter",0x511b0b88,"openfl.filters.BlurFilter.__applyFilter","openfl/filters/BlurFilter.hx",194,0x46563eac)
...
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_82_boot,"openfl.filters.BlurFilter","boot",0xbff97d90,"openfl.filters.BlurFilter.boot","openfl/filters/BlurFilter.hx",82,0x46563eac)
namespace openfl{
namespace filters{
...
int quality = __o_quality.Default(1);
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_172_new)
HXLINE( 174)		super::__construct();
HXLINE( 176)		this->set_blurX(blurX);
HXLINE( 177)		this->set_blurY(blurY);
HXLINE( 178)		this->set_quality(quality);
HXLINE( 180)		this->_hx___needSecondBitmapData = true;
HXLINE( 181)		this->_hx___preserveObject = false;
HXLINE( 182)		this->_hx___renderDirty = true;
            	}
...
bool BlurFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter BlurFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_6e95f8db175a4230_189_clone)
HXDLIN( 189)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->_hx___blurX,this->_hx___blurY,this->_hx___quality);
            	}
 ...
 ::openfl::display::BitmapData BlurFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_194___applyFilter)
HXLINE( 196)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 196)		 ::lime::graphics::Image sourceBitmapData1 = sourceBitmapData->image;
HXDLIN( 196)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 196)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 196)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null());
HXLINE( 197)		if (hx::IsEq( finalImage2,bitmapData->image )) {
HXLINE( 197)			return bitmapData;
            		}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_6e95f8db175a4230_82_boot)
HXDLIN(  82)		_hx___blurShader =  ::openfl::filters::_BlurFilter::BlurShader_obj::__alloc( HX_CTX );
            	}
}
