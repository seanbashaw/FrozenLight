...
HX_LOCAL_STACK_FRAME(_hx_pos_6b0b98c45b3017d4_22_init,"ManifestResources","init",0xc8e10c68,"ManifestResources.init","ManifestResources.hx",22,0xf77aa668)
...
void ManifestResources_obj::init( ::Dynamic config){
            	HX_STACKFRAME(&_hx_pos_6b0b98c45b3017d4_22_init)
HXLINE(  24)		::ManifestResources_obj::preloadLibraries = ::Array_obj< ::Dynamic>::__new();
HXLINE(  25)		::ManifestResources_obj::preloadLibraryNames = ::Array_obj< ::String >::__new();
HXLINE(  27)		::String rootPath = null();
HXLINE(  29)		bool _hx_tmp;
HXDLIN(  29)		if (hx::IsNotNull( config )) {
HXLINE(  29)			_hx_tmp = ::Reflect_obj::hasField(config,HX_("rootPath",e7,b8,88,e1));
            		}
            		else {
HXLINE(  29)			_hx_tmp = false;
            		}
HXDLIN(  29)		if (_hx_tmp) {
HXLINE(  31)			rootPath = ( (::String)(::Reflect_obj::field(config,HX_("rootPath",e7,b8,88,e1))) );
            		}
HXLINE(  35)		if (hx::IsNull( rootPath )) {
HXLINE(  40)			rootPath = (::sys::FileSystem_obj::absolutePath(::haxe::io::Path_obj::directory(::Sys_obj::programPath())) + HX_("/",2f,00,00,00));
            		}
HXLINE(  47)		::lime::utils::Assets_obj::defaultRootPath = rootPath;
HXLINE(  50)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  51)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  55)		 ::Dynamic data;
HXDLIN(  55)		 ::Dynamic manifest;
HXDLIN(  55)		 ::lime::utils::AssetLibrary library;
HXLINE(  68)		{
HXLINE(  68)			::String v = (rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  68)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  71)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  72)		if (hx::IsNotNull( library )) {
HXLINE(  72)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  73)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
