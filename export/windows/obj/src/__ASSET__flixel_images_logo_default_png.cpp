...
HX_DEFINE_STACK_FRAME(_hx_pos_17702da0942c0225_345_new,"__ASSET__flixel_images_logo_default_png","new",0xe2ac399d,"__ASSET__flixel_images_logo_default_png.new","lime/_internal/macros/AssetsMacro.hx",345,0xc651f030)
...
void __ASSET__flixel_images_logo_default_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_17702da0942c0225_345_new)
HXLINE( 382)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 384)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName),null());
            	}
