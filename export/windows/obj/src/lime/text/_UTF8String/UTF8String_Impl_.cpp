...
HXDLIN(  41)						HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,codePoint));
            					}
            				}
            			}
            		}
...
HXDLIN(  57)			_hx_tmp = (index >= ::lime::_internal::unifill::_Utf8::Utf8_Impl__obj::codePointCount(this3,(int)0,this1.length));
            		}
            		else {
...
HXDLIN(  71)			HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,code));
            		}
...
HXDLIN(  71)						HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,this2));
            					}
            				}
            			}
            		}
...
HXDLIN(  88)				if (!(s1)) {
HXLINE(  88)					HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,code));
            				}
...
HXLINE(  88)								HX_STACK_DO_THROW( ::lime::_internal::unifill::InvalidCodePoint_obj::__alloc( HX_CTX ,b));
            							}
            						}
            					}
            				}
...
HXDLIN( 110)			return ::lime::_internal::unifill::_Utf8::Utf8_Impl__obj::codePointCount(this11,(int)0,index8);
            		}
            		else {
...
HXDLIN( 128)			return ::lime::_internal::unifill::_Utf8::Utf8_Impl__obj::codePointCount(this11,(int)0,index8);
            		}
            		else {
...
HXLINE( 291)		return (::lime::_internal::unifill::Unifill_obj::uCompare(a,b) == (int)0);
            	}
...
HXLINE( 300)		return (::lime::_internal::unifill::Unifill_obj::uCompare(a,b) == (int)-1);
            	}
...
HXLINE( 309)		return (::lime::_internal::unifill::Unifill_obj::uCompare(a,b) == (int)1);
            	}
...
HXLINE( 318)		return (::lime::_internal::unifill::Unifill_obj::uCompare(a,b) != (int)1);
            	}
...
HXLINE( 327)		return (::lime::_internal::unifill::Unifill_obj::uCompare(a,b) != (int)-1);
            	}
