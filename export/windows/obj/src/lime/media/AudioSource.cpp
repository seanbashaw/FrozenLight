...
HXLINE(  36)		this->_hx___backend =  ::lime::_internal::backend::native::NativeAudioSource_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this));
...
HXDLIN(  57)		this->_hx___backend->dispose();
            	}
...
HXDLIN(  64)		this->_hx___backend->init();
            	}
...
HXDLIN(  71)		this->_hx___backend->play();
            	}
...
HXDLIN(  78)		this->_hx___backend->pause();
            	}
...
HXDLIN(  85)		this->_hx___backend->stop();
            	}
...
HXDLIN(  99)		return this->_hx___backend->getCurrentTime();
            	}
...
HXDLIN( 106)		return this->_hx___backend->setCurrentTime(value);
            	}
...
HXDLIN( 113)		return this->_hx___backend->getGain();
            	}
...
HXDLIN( 120)		return this->_hx___backend->setGain(value);
            	}
...
HXDLIN( 127)		return this->_hx___backend->getLength();
            	}
...
HXDLIN( 134)		return this->_hx___backend->setLength(value);
            	}
...
HXDLIN( 141)		return this->_hx___backend->getLoops();
            	}
...
HXDLIN( 148)		return this->_hx___backend->setLoops(value);
            	}
...
HXDLIN( 155)		return this->_hx___backend->getPosition();
            	}
...
HXDLIN( 162)		return this->_hx___backend->setPosition(value);
            	}
