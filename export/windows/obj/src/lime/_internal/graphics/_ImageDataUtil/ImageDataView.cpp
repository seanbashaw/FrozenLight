...
HX_DEFINE_STACK_FRAME(_hx_pos_0f70c5927802d56d_1592_new,"lime._internal.graphics._ImageDataUtil.ImageDataView","new",0x36089ace,"lime._internal.graphics._ImageDataUtil.ImageDataView.new","lime/_internal/graphics/ImageDataUtil.hx",1592,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1619_clip,"lime._internal.graphics._ImageDataUtil.ImageDataView","clip",0x0a3ec4a2,"lime._internal.graphics._ImageDataUtil.ImageDataView.clip","lime/_internal/graphics/ImageDataUtil.hx",1619,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1632_hasRow,"lime._internal.graphics._ImageDataUtil.ImageDataView","hasRow",0xdbd8dd32,"lime._internal.graphics._ImageDataUtil.ImageDataView.hasRow","lime/_internal/graphics/ImageDataUtil.hx",1632,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1637_offset,"lime._internal.graphics._ImageDataUtil.ImageDataView","offset",0x80da85e5,"lime._internal.graphics._ImageDataUtil.ImageDataView.offset","lime/_internal/graphics/ImageDataUtil.hx",1637,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1670_row,"lime._internal.graphics._ImageDataUtil.ImageDataView","row",0x360bac88,"lime._internal.graphics._ImageDataUtil.ImageDataView.row","lime/_internal/graphics/ImageDataUtil.hx",1670,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1675___update,"lime._internal.graphics._ImageDataUtil.ImageDataView","__update",0xdf2597fb,"lime._internal.graphics._ImageDataUtil.ImageDataView.__update","lime/_internal/graphics/ImageDataUtil.hx",1675,0x59dddace)
namespace lime{
namespace _internal{
namespace graphics{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1592_new)
HXLINE(1594)		this->image = image;
HXLINE(1596)		if (hx::IsNull( rect )) {
HXLINE(1598)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1602)			if ((rect->x < (int)0)) {
HXLINE(1602)				rect->x = (int)0;
            			}
HXLINE(1603)			if ((rect->y < (int)0)) {
HXLINE(1603)				rect->y = (int)0;
            			}
HXLINE(1604)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1604)				rect->width = (image->width - rect->x);
            			}
HXLINE(1605)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1605)				rect->height = (image->height - rect->y);
            			}
HXLINE(1606)			if ((rect->width < (int)0)) {
HXLINE(1606)				rect->width = (int)0;
            			}
HXLINE(1607)			if ((rect->height < (int)0)) {
HXLINE(1607)				rect->height = (int)0;
            			}
HXLINE(1608)			this->rect = rect;
            		}
HXLINE(1612)		this->stride = image->buffer->get_stride();
HXLINE(1614)		this->_hx___update();
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_0f70c5927802d56d_1619_clip)
HXLINE(1621)		if (hx::IsNull( this->tempRect )) {
HXLINE(1621)			this->tempRect =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
HXLINE(1622)		this->tempRect->setTo(x,y,width,height);
HXLINE(1624)		this->rect->intersection(this->tempRect,this->rect);
HXLINE(1625)		this->_hx___update();
            	}
...
bool ImageDataView_obj::hasRow(int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1632_hasRow)
HXDLIN(1632)		if ((y >= (int)0)) {
HXDLIN(1632)			return (y < this->height);
            		}
            		else {
HXDLIN(1632)			return false;
            		}
HXDLIN(1632)		return false;
            	}
...
void ImageDataView_obj::offset(int x,int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1637_offset)
HXLINE(1639)		if ((x < (int)0)) {
HXLINE(1641)			 ::lime::math::Rectangle _hx_tmp = this->rect;
HXDLIN(1641)			_hx_tmp->x = (_hx_tmp->x + x);
HXLINE(1642)			if ((this->rect->x < (int)0)) {
HXLINE(1642)				this->rect->x = (int)0;
            			}
            		}
            		else {
HXLINE(1646)			 ::lime::math::Rectangle _hx_tmp1 = this->rect;
HXDLIN(1646)			_hx_tmp1->x = (_hx_tmp1->x + x);
HXLINE(1647)			 ::lime::math::Rectangle _hx_tmp2 = this->rect;
HXDLIN(1647)			_hx_tmp2->width = (_hx_tmp2->width - x);
            		}
HXLINE(1651)		if ((y < (int)0)) {
HXLINE(1653)			 ::lime::math::Rectangle _hx_tmp3 = this->rect;
HXDLIN(1653)			_hx_tmp3->y = (_hx_tmp3->y + y);
HXLINE(1654)			if ((this->rect->y < (int)0)) {
HXLINE(1654)				this->rect->y = (int)0;
            			}
            		}
            		else {
HXLINE(1658)			 ::lime::math::Rectangle _hx_tmp4 = this->rect;
HXDLIN(1658)			_hx_tmp4->y = (_hx_tmp4->y + y);
HXLINE(1659)			 ::lime::math::Rectangle _hx_tmp5 = this->rect;
HXDLIN(1659)			_hx_tmp5->height = (_hx_tmp5->height - y);
            		}
HXLINE(1663)		this->_hx___update();
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1670_row)
HXDLIN(1670)		int _hx_tmp = this->byteOffset;
HXDLIN(1670)		return (_hx_tmp + (this->stride * y));
            	}
...
void ImageDataView_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1675___update)
HXLINE(1677)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1678)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1679)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1680)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1681)		int _hx_tmp = this->stride;
HXDLIN(1681)		int _hx_tmp1 = (_hx_tmp * (this->y + this->image->offsetY));
HXDLIN(1681)		this->byteOffset = (_hx_tmp1 + ((this->x + this->image->offsetX) * (int)4));
            	}
