...
HX_DEFINE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_910_new,"lime._internal.backend.native.KeyEventInfo","new",0x84b8978d,"lime._internal.backend.native.KeyEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",910,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_cef4a471e9b9c478_922_clone,"lime._internal.backend.native.KeyEventInfo","clone",0x44e9bfca,"lime._internal.backend.native.KeyEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",922,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int modifier = __o_modifier.Default(0);
            	HX_STACKFRAME(&_hx_pos_cef4a471e9b9c478_910_new)
HXLINE( 912)		this->type = type;
HXLINE( 913)		this->windowID = windowID;
HXLINE( 914)		this->keyCode = keyCode;
HXLINE( 915)		this->modifier = modifier;
            	}
...
bool KeyEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cef4a471e9b9c478_922_clone)
HXDLIN( 922)		return  ::lime::_internal::backend::native::KeyEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->keyCode,this->modifier);
            	}
