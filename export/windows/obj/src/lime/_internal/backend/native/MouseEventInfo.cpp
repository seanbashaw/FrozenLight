...
HX_DEFINE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_951_new,"lime._internal.backend.native.MouseEventInfo","new",0x46fd57c7,"lime._internal.backend.native.MouseEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",951,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_3eb566585b06ea2e_966_clone,"lime._internal.backend.native.MouseEventInfo","clone",0xb20a8284,"lime._internal.backend.native.MouseEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",966,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
Float movementY = __o_movementY.Default(0);
            	HX_STACKFRAME(&_hx_pos_3eb566585b06ea2e_951_new)
HXLINE( 953)		this->type = type;
HXLINE( 954)		this->windowID = (int)0;
HXLINE( 955)		this->x = x;
HXLINE( 956)		this->y = y;
HXLINE( 957)		this->button = button;
HXLINE( 958)		this->movementX = movementX;
HXLINE( 959)		this->movementY = movementY;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3eb566585b06ea2e_966_clone)
HXDLIN( 966)		return  ::lime::_internal::backend::native::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY);
            	}
