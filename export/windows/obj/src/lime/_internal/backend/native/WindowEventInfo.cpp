...
HX_DEFINE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1151_new,"lime._internal.backend.native.WindowEventInfo","new",0x4cd621b8,"lime._internal.backend.native.WindowEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1151,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1165_clone,"lime._internal.backend.native.WindowEventInfo","clone",0x771e6ab5,"lime._internal.backend.native.WindowEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1165,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_1151_new)
HXLINE(1153)		this->type = type;
HXLINE(1154)		this->windowID = windowID;
HXLINE(1155)		this->width = width;
HXLINE(1156)		this->height = height;
HXLINE(1157)		this->x = x;
HXLINE(1158)		this->y = y;
            	}
...
bool WindowEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_1165_clone)
HXDLIN(1165)		return  ::lime::_internal::backend::native::WindowEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
