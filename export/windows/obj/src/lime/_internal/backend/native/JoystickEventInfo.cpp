...
HX_DEFINE_STACK_FRAME(_hx_pos_21cd05885e6e0032_866_new,"lime._internal.backend.native.JoystickEventInfo","new",0x6a2decec,"lime._internal.backend.native.JoystickEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",866,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_21cd05885e6e0032_880_clone,"lime._internal.backend.native.JoystickEventInfo","clone",0x72666ae9,"lime._internal.backend.native.JoystickEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",880,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_21cd05885e6e0032_866_new)
HXLINE( 868)		this->type = type;
HXLINE( 869)		this->id = id;
HXLINE( 870)		this->index = index;
HXLINE( 871)		this->eventValue = value;
HXLINE( 872)		this->x = x;
HXLINE( 873)		this->y = y;
            	}
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_21cd05885e6e0032_880_clone)
HXDLIN( 880)		return  ::lime::_internal::backend::native::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->eventValue,this->x,this->y);
            	}
