...
HX_DEFINE_STACK_FRAME(_hx_pos_48b909785036aaec_1065_new,"lime._internal.backend.native.TextEventInfo","new",0x7aff2f5b,"lime._internal.backend.native.TextEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1065,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_48b909785036aaec_1078_clone,"lime._internal.backend.native.TextEventInfo","clone",0x4be06718,"lime._internal.backend.native.TextEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1078,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
int length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_48b909785036aaec_1065_new)
HXLINE(1067)		this->type = type;
HXLINE(1068)		this->windowID = windowID;
HXLINE(1069)		this->text = text;
HXLINE(1070)		this->start = start;
HXLINE(1071)		this->length = length;
            	}
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_48b909785036aaec_1078_clone)
HXDLIN(1078)		return  ::lime::_internal::backend::native::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
