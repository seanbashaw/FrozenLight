...
HXLINE( 133)					data = ::haxe::io::Bytes_obj::ofString(query);
            				}
            			}
...
HXLINE( 326)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer =  ::haxe::Timer_obj::__alloc( HX_CTX ,(int)30);
...
HXLINE( 357)				::String _hx_tmp = bytes->getString((int)0,bytes->length);
...
HXLINE( 438)		while(hx::IsNotNull( message )){
HXLINE( 440)			curl = message->curl;
HXLINE( 442)			if (::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->exists(curl)) {
HXLINE( 444)				instance = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get(curl).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXLINE( 445)				::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->remove(curl);
HXLINE( 447)				status = ( (int)(curl->getInfo((int)2097154)) );
HXLINE( 448)				instance->parent->__SetField(HX_("responseStatus",93,60,a4,78),status,hx::paccDynamic);
HXLINE( 450)				curl->cleanup();
HXLINE( 451)				curl = null();
HXLINE( 453)				if ((message->result == (int)0)) {
HXLINE( 455)					bool _hx_tmp;
HXDLIN( 455)					bool _hx_tmp1;
HXDLIN( 455)					if ((status >= (int)200)) {
HXLINE( 455)						_hx_tmp1 = (status < (int)400);
            					}
            					else {
HXLINE( 455)						_hx_tmp1 = false;
            					}
HXDLIN( 455)					if (!(_hx_tmp1)) {
HXLINE( 455)						_hx_tmp = (status == (int)0);
            					}
            					else {
HXLINE( 455)						_hx_tmp = true;
            					}
HXDLIN( 455)					if (_hx_tmp) {
HXLINE( 457)						if (!(instance->promise->get_isError())) {
HXLINE( 459)							instance->promise->complete(instance->bytes);
            						}
            					}
            					else {
HXLINE( 463)						if (hx::IsNotNull( instance->bytes )) {
HXLINE( 465)							 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 465)							instance1->error(instance->bytes->getString((int)0,instance->bytes->length));
            						}
            						else {
HXLINE( 469)							 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 469)							instance2->error((HX_("Status ",8e,8c,bf,03) + status));
            						}
            					}
            				}
            				else {
HXLINE( 475)					 ::lime::app::Promise_haxe_io_Bytes instance3 = instance->promise;
HXDLIN( 475)					instance3->error(::lime::net::curl::CURL_obj::strerror(message->result));
            				}
HXLINE( 479)				if (hx::IsNotNull( instance->timeout )) {
HXLINE( 481)					instance->timeout->stop();
HXLINE( 482)					instance->timeout = null();
            				}
HXLINE( 486)				instance->bytes = null();
HXLINE( 487)				instance->promise = null();
            			}
HXLINE( 491)			message = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->infoRead();
            		}
HXLINE( 495)		if ((::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->get_runningHandles() == (int)0)) {
HXLINE( 497)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer->stop();
HXLINE( 498)			::lime::_internal::backend::native::NativeHTTPRequest_obj::multiTimer = null();
            		}
            	}
