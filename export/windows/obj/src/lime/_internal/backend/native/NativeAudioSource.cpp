...
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_149_play,"lime._internal.backend.native.NativeAudioSource","play",0x07dd247a,"lime._internal.backend.native.NativeAudioSource.play","lime/_internal/backend/native/NativeAudioSource.hx",149,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_209_pause,"lime._internal.backend.native.NativeAudioSource","pause",0xd26c95b0,"lime._internal.backend.native.NativeAudioSource.pause","lime/_internal/backend/native/NativeAudioSource.hx",209,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_231_readVorbisFileBuffer,"lime._internal.backend.native.NativeAudioSource","readVorbisFileBuffer",0x5a6427cb,"lime._internal.backend.native.NativeAudioSource.readVorbisFileBuffer","lime/_internal/backend/native/NativeAudioSource.hx",231,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_273_refillBuffers,"lime._internal.backend.native.NativeAudioSource","refillBuffers",0x8dd34f17,"lime._internal.backend.native.NativeAudioSource.refillBuffers","lime/_internal/backend/native/NativeAudioSource.hx",273,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_340_stop,"lime._internal.backend.native.NativeAudioSource","stop",0x09dee688,"lime._internal.backend.native.NativeAudioSource.stop","lime/_internal/backend/native/NativeAudioSource.hx",340,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_374_streamTimer_onRun,"lime._internal.backend.native.NativeAudioSource","streamTimer_onRun",0xd26ae54c,"lime._internal.backend.native.NativeAudioSource.streamTimer_onRun","lime/_internal/backend/native/NativeAudioSource.hx",374,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_379_timer_onRun,"lime._internal.backend.native.NativeAudioSource","timer_onRun",0x98b8aa6c,"lime._internal.backend.native.NativeAudioSource.timer_onRun","lime/_internal/backend/native/NativeAudioSource.hx",379,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_408_getCurrentTime,"lime._internal.backend.native.NativeAudioSource","getCurrentTime",0xb0ab91f6,"lime._internal.backend.native.NativeAudioSource.getCurrentTime","lime/_internal/backend/native/NativeAudioSource.hx",408,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_443_setCurrentTime,"lime._internal.backend.native.NativeAudioSource","setCurrentTime",0xd0cb7a6a,"lime._internal.backend.native.NativeAudioSource.setCurrentTime","lime/_internal/backend/native/NativeAudioSource.hx",443,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_510_getGain,"lime._internal.backend.native.NativeAudioSource","getGain",0x29af016f,"lime._internal.backend.native.NativeAudioSource.getGain","lime/_internal/backend/native/NativeAudioSource.hx",510,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_523_setGain,"lime._internal.backend.native.NativeAudioSource","setGain",0x1cb0927b,"lime._internal.backend.native.NativeAudioSource.setGain","lime/_internal/backend/native/NativeAudioSource.hx",523,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_536_getLength,"lime._internal.backend.native.NativeAudioSource","getLength",0x8531c1d6,"lime._internal.backend.native.NativeAudioSource.getLength","lime/_internal/backend/native/NativeAudioSource.hx",536,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_549_setLength,"lime._internal.backend.native.NativeAudioSource","setLength",0x6882ade2,"lime._internal.backend.native.NativeAudioSource.setLength","lime/_internal/backend/native/NativeAudioSource.hx",549,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_577_getLoops,"lime._internal.backend.native.NativeAudioSource","getLoops",0x39b8b29f,"lime._internal.backend.native.NativeAudioSource.getLoops","lime/_internal/backend/native/NativeAudioSource.hx",577,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_584_setLoops,"lime._internal.backend.native.NativeAudioSource","setLoops",0xe8160c13,"lime._internal.backend.native.NativeAudioSource.setLoops","lime/_internal/backend/native/NativeAudioSource.hx",584,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_589_getPosition,"lime._internal.backend.native.NativeAudioSource","getPosition",0x31bde999,"lime._internal.backend.native.NativeAudioSource.getPosition","lime/_internal/backend/native/NativeAudioSource.hx",589,0xce8e0834)
HX_LOCAL_STACK_FRAME(_hx_pos_a101d5e86f44bfa1_607_setPosition,"lime._internal.backend.native.NativeAudioSource","setPosition",0x3c2af0a5,"lime._internal.backend.native.NativeAudioSource.setPosition","lime/_internal/backend/native/NativeAudioSource.hx",607,0xce8e0834)
...
void NativeAudioSource_obj::play(){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_149_play)
...
HXLINE( 193)			this->streamTimer =  ::haxe::Timer_obj::__alloc( HX_CTX ,::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_TIMER_FREQUENCY);
HXLINE( 194)			this->streamTimer->run = this->streamTimer_onRun_dyn();
            		}
            		else {
HXLINE( 198)			int time;
HXDLIN( 198)			if (this->completed) {
HXLINE( 198)				time = (int)0;
            			}
            			else {
HXLINE( 198)				time = this->getCurrentTime();
            			}
...
void NativeAudioSource_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_209_pause)
...
HX_DEFINE_DYNAMIC_FUNC0(NativeAudioSource_obj,pause,(void))
 ...
 ::lime::utils::ArrayBufferView NativeAudioSource_obj::readVorbisFileBuffer( ::lime::media::vorbis::VorbisFile vorbisFile,int length){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_231_readVorbisFileBuffer)
...
void NativeAudioSource_obj::refillBuffers(::cpp::VirtualArray buffers){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_273_refillBuffers)
HXLINE( 277)		 ::lime::media::vorbis::VorbisFile vorbisFile = null();
...
HXLINE( 313)					if (((this->dataLength - position) >= ::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_BUFFER_SIZE)) {
HXLINE( 315)						data = this->readVorbisFileBuffer(vorbisFile,::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_BUFFER_SIZE);
HXLINE( 316)						::lime::media::openal::AL_obj::bufferData(buffer,this->format,data,data->length,this->parent->buffer->sampleRate);
HXLINE( 317)						position = (position + ::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_BUFFER_SIZE);
...
void NativeAudioSource_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_340_stop)
...
void NativeAudioSource_obj::streamTimer_onRun(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_374_streamTimer_onRun)
...
void NativeAudioSource_obj::timer_onRun(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_379_timer_onRun)
...
int NativeAudioSource_obj::getCurrentTime(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_408_getCurrentTime)
...
int NativeAudioSource_obj::setCurrentTime(int value){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_443_setCurrentTime)
...
HXLINE( 451)				 ::lime::media::vorbis::VorbisFile _hx_tmp = this->parent->buffer->_hx___srcVorbisFile;
HXDLIN( 451)				_hx_tmp->timeSeek(((Float)(value + this->parent->offset) / (Float)(int)1000));
HXLINE( 452)				::lime::media::openal::AL_obj::sourceUnqueueBuffers(this->handle,::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_NUM_BUFFERS);
...
HXLINE( 496)				this->playing = false;
HXLINE( 497)				this->completed = true;
            			}
            		}
...
Float NativeAudioSource_obj::getGain(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_510_getGain)
HXDLIN( 510)		if (hx::IsNotNull( this->handle )) {
HXLINE( 512)			return ::lime::media::openal::AL_obj::getSourcef(this->handle,(int)4106);
            		}
            		else {
HXLINE( 516)			return (int)1;
            		}
HXLINE( 510)		return ((Float)0.);
            	}
...
Float NativeAudioSource_obj::setGain(Float value){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_523_setGain)
HXLINE( 525)		if (hx::IsNotNull( this->handle )) {
HXLINE( 527)			::lime::media::openal::AL_obj::sourcef(this->handle,(int)4106,value);
            		}
...
int NativeAudioSource_obj::getLength(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_536_getLength)
HXLINE( 538)		if (hx::IsNotNull( this->length )) {
HXLINE( 540)			return this->length;
            		}
HXLINE( 544)		int _hx_tmp = ::Std_obj::_hx_int((((Float)this->samples / (Float)this->parent->buffer->sampleRate) * (int)1000));
HXDLIN( 544)		return (_hx_tmp - this->parent->offset);
            	}
...
int NativeAudioSource_obj::setLength(int value){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_549_setLength)
HXLINE( 551)		bool _hx_tmp;
HXDLIN( 551)		if (this->playing) {
HXLINE( 551)			_hx_tmp = hx::IsNotEq( this->length,value );
            		}
            		else {
HXLINE( 551)			_hx_tmp = false;
            		}
HXDLIN( 551)		if (_hx_tmp) {
HXLINE( 553)			if (hx::IsNotNull( this->timer )) {
HXLINE( 555)				this->timer->stop();
            			}
HXLINE( 559)			int timeRemaining = (value - this->getCurrentTime());
HXLINE( 561)			if ((timeRemaining > (int)0)) {
HXLINE( 563)				this->timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,timeRemaining);
HXLINE( 564)				this->timer->run = this->timer_onRun_dyn();
            			}
            		}
HXLINE( 570)		return (this->length = value);
            	}
...
int NativeAudioSource_obj::getLoops(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_577_getLoops)
HXDLIN( 577)		return this->loops;
            	}
...
int NativeAudioSource_obj::setLoops(int value){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_584_setLoops)
HXDLIN( 584)		return (this->loops = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(NativeAudioSource_obj,setLoops,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::getPosition(){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_589_getPosition)
HXLINE( 591)		if (hx::IsNotNull( this->handle )) {
HXLINE( 594)			::Array< Float > value = ::lime::media::openal::AL_obj::getSource3f(this->handle,(int)4100);
HXLINE( 595)			this->position->x = value->__get((int)0);
HXLINE( 596)			this->position->y = value->__get((int)1);
HXLINE( 597)			this->position->z = value->__get((int)2);
            		}
HXLINE( 602)		return this->position;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(NativeAudioSource_obj,getPosition,return )
 ...
 ::lime::math::Vector4 NativeAudioSource_obj::setPosition( ::lime::math::Vector4 value){
            	HX_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_607_setPosition)
HXLINE( 609)		this->position->x = value->x;
HXLINE( 610)		this->position->y = value->y;
HXLINE( 611)		this->position->z = value->z;
HXLINE( 612)		this->position->w = value->w;
HXLINE( 614)		if (hx::IsNotNull( this->handle )) {
HXLINE( 616)			::lime::media::openal::AL_obj::distanceModel((int)0);
HXLINE( 617)			::lime::media::openal::AL_obj::source3f(this->handle,(int)4100,this->position->x,this->position->y,this->position->z);
            		}
HXLINE( 621)		return this->position;
            	}
