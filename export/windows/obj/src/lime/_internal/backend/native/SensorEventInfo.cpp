...
HX_DEFINE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_1026_new,"lime._internal.backend.native.SensorEventInfo","new",0xcd81dd2e,"lime._internal.backend.native.SensorEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",1026,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_1039_clone,"lime._internal.backend.native.SensorEventInfo","clone",0x46c86fab,"lime._internal.backend.native.SensorEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1039,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
Float z = __o_z.Default(0);
            	HX_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_1026_new)
HXLINE(1028)		this->type = type;
HXLINE(1029)		this->id = id;
HXLINE(1030)		this->x = x;
HXLINE(1031)		this->y = y;
HXLINE(1032)		this->z = z;
            	}
...
bool SensorEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_1039_clone)
HXDLIN(1039)		return  ::lime::_internal::backend::native::SensorEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->x,this->y,this->z);
            	}
