...
HX_LOCAL_STACK_FRAME(_hx_pos_0170168071f82217_305_fromBytes,"lime.net._HTTPRequest_openfl_utils_ByteArray","fromBytes",0xc0fc2794,"lime.net._HTTPRequest_openfl_utils_ByteArray.fromBytes","openfl/net/URLLoader.hx",305,0x11daec0d)
namespace lime{
namespace net{
...
bool _HTTPRequest_openfl_utils_ByteArray_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_openfl_utils_ByteArray_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_0170168071f82217_305_fromBytes)
HXDLIN( 305)		return ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(bytes);
            	}
