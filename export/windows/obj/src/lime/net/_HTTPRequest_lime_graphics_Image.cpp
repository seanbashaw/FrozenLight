...
HX_LOCAL_STACK_FRAME(_hx_pos_31224ac778a9eff4_1172_fromBytes,"lime.net._HTTPRequest_lime_graphics_Image","fromBytes",0xef825737,"lime.net._HTTPRequest_lime_graphics_Image.fromBytes","lime/graphics/Image.hx",1172,0xc7b862ad)
namespace lime{
namespace net{
...
bool _HTTPRequest_lime_graphics_Image_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_graphics_Image_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_31224ac778a9eff4_1172_fromBytes)
HXDLIN(1172)		return ::lime::graphics::Image_obj::fromBytes(bytes);
            	}
