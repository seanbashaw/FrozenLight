...
class HXCPP_CLASS_ATTRIBUTES Uniform_obj : public hx::Object
{
	...
	public:
		...
		static hx::ObjectPtr< Uniform_obj > __new( ::lime::graphics::RenderContext context);
		static hx::ObjectPtr< Uniform_obj > __alloc(hx::Ctx *_hx_ctx, ::lime::graphics::RenderContext context);
