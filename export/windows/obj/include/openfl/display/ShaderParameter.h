...
class HXCPP_CLASS_ATTRIBUTES ShaderParameter_obj : public hx::Object
{
	...
	public:
		...
		bool _hx___useArray;
		void _hx___disableGL( ::lime::graphics::RenderContext context);
		::Dynamic _hx___disableGL_dyn();

		void _hx___updateGL( ::lime::graphics::RenderContext context,::cpp::VirtualArray overrideValue);
		::Dynamic _hx___updateGL_dyn();

		void _hx___updateGLFromBuffer( ::lime::graphics::RenderContext context, ::lime::utils::ArrayBufferView buffer,int position,int length);
