...
class HXCPP_CLASS_ATTRIBUTES OpenGLRenderer_obj : public  ::openfl::display::DisplayObjectRenderer_obj
{
	...
	public:
		...
		void __construct( ::lime::graphics::RenderContext context, ::openfl::display::BitmapData defaultRenderTarget);
		...
		static hx::ObjectPtr< OpenGLRenderer_obj > __new( ::lime::graphics::RenderContext context, ::openfl::display::BitmapData defaultRenderTarget);
		static hx::ObjectPtr< OpenGLRenderer_obj > __alloc(hx::Ctx *_hx_ctx, ::lime::graphics::RenderContext context, ::openfl::display::BitmapData defaultRenderTarget);
