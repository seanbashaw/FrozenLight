...
class HXCPP_CLASS_ATTRIBUTES ShaderInput_obj : public hx::Object
{
	...
	public:
		...
		void _hx___updateGL( ::lime::graphics::RenderContext context,int id, ::Dynamic overrideInput, ::Dynamic overrideFilter, ::Dynamic overrideMipFilter, ::Dynamic overrideWrap);
