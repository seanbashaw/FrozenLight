...
class HXCPP_CLASS_ATTRIBUTES BitmapData_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic generateFilterRect_dyn();
		 ...
		 ::lime::graphics::opengl::GLObject getBuffer( ::lime::graphics::RenderContext context);
		...
		::Dynamic getSurface_dyn();
		 ...
		 ::lime::graphics::opengl::GLObject getTexture( ::lime::graphics::RenderContext context);
		...
		::Dynamic _hx___getBounds_dyn();
		 ...
		 ::lime::graphics::opengl::GLObject _hx___getFramebuffer( ::lime::graphics::RenderContext context,bool requireStencil);
		...
		void _hx___setUVRect( ::lime::graphics::RenderContext context,Float x,Float y,Float width,Float height);
