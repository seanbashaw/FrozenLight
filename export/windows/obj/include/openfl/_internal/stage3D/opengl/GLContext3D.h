...
class HXCPP_CLASS_ATTRIBUTES GLContext3D_obj : public hx::Object
{
	...
	public:
		...
		static void _hx___setContext( ::openfl::display3D::Context3D context);
		static ::Dynamic _hx___setContext_dyn();
		...
		static void _hx___updateDepthAndStencilStateTEMP( ::openfl::display3D::Context3D context);
		static ::Dynamic _hx___updateDepthAndStencilStateTEMP_dyn();

		static void _hx___updateScissorRectangle();
		static ::Dynamic _hx___updateScissorRectangle_dyn();

		static void _hx___updateScissorRectangleTEMP( ::openfl::display3D::Context3D context);
		static ::Dynamic _hx___updateScissorRectangleTEMP_dyn();
