...
class HXCPP_CLASS_ATTRIBUTES GLCompressedTextureFormats_obj : public hx::Object
{
	...
	public:
		...
		void __construct( ::lime::graphics::RenderContext context);
		...
		static hx::ObjectPtr< GLCompressedTextureFormats_obj > __new( ::lime::graphics::RenderContext context);
		static hx::ObjectPtr< GLCompressedTextureFormats_obj > __alloc(hx::Ctx *_hx_ctx, ::lime::graphics::RenderContext context);
		...
		void checkDXT( ::lime::graphics::RenderContext context);
		::Dynamic checkDXT_dyn();

		void checkETC1( ::lime::graphics::RenderContext context);
		::Dynamic checkETC1_dyn();

		void checkPVRTC( ::lime::graphics::RenderContext context);
