...
class HXCPP_CLASS_ATTRIBUTES ImageDataUtil_obj : public hx::Object
{
	...
	public:
		...
		static void translatePixel( ::lime::utils::ArrayBufferView imgB, ::lime::math::Rectangle sourceRect, ::lime::math::Rectangle destRect, ::lime::math::Vector2 destPoint,int destX,int destY,Float strength);
