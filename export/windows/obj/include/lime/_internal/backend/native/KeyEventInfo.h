...
HX_DECLARE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_910_new)
...
HXLINE( 912)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->type = type;
HXLINE( 913)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 914)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 915)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->modifier = modifier;
            	}
