...
HX_DECLARE_STACK_FRAME(_hx_pos_48b909785036aaec_1065_new)
...
HXLINE(1067)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->type = type;
HXLINE(1068)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->windowID = windowID;
HXLINE(1069)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->text = text;
HXLINE(1070)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->start = start;
HXLINE(1071)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->length = length;
            	}
