...
HX_DECLARE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_1026_new)
...
HXLINE(1028)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->type = type;
HXLINE(1029)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->id = id;
HXLINE(1030)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->x = x;
HXLINE(1031)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->y = y;
HXLINE(1032)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->z = z;
            	}
