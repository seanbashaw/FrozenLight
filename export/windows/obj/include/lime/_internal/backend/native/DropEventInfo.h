...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_788_new)
...
HXLINE( 790)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = type;
HXLINE( 791)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
